...
namespace Nistec.SyntaxEditor
{
	...
	public class SearchDlg : System.Windows.Forms.Form
	{
        ...
        public SearchDlg(TextEditor editor)
		{
			//
            ...
            string word = editor.GetCurrentWord();
			cboWord.Text = word;
        ...
        public SearchDlg(TextEditor editor, bool replace)
		{	
			InitializeComponent();
			this.Text = "Replace";
            _CtlSyntaxEditor = editor;
		...
		private void btn_FindNext_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                _lastPos = _CtlSyntaxEditor.Find(regex, _lastPos);
		...
		private void btnReplace_Click(object sender, System.EventArgs e)
		{
            ...
            _lastPos = _CtlSyntaxEditor.Replace(regex, _lastPos, txtReplacewith.Text);
		...
		private void btnReplaceAll_Click(object sender, System.EventArgs e)
		{
            ...
            _CtlSyntaxEditor.ReplaceAll(regex, txtReplacewith.Text);
