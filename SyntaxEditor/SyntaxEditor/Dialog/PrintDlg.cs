...
{
	public class PrintDlg : BaseDialog
	{
        ...
        public PrintDlg(TextEditor editor)
		{
		...
		private void btnOk_Click(object sender, System.EventArgs e)
		{
            try
            {
                _CtlSyntaxEditor.PrintDocument.Print();
            }
            catch (Exception ex)
            {
            ...
            //if (rbOutPut.Checked)
            //    _CtlSyntaxEditor.PrintOutPut(cbPreView.Checked);
            //else
            //    _CtlSyntaxEditor.PrintStatement(cbPreView.Checked);
