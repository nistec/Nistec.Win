...
namespace Nistec.SyntaxEditor.UI
{
	...
	public class FoldMargin : AbstractMargin
	{
		...
		public override bool IsVisible {
			get {
				return textArea.SyntaxProperties.EnableFolding;
			}
		}
		...
		public override void Paint(Graphics g, Rectangle rect)
		{
			...
			for (int y = 0; y < (DrawingPosition.Height + textArea.TextView.VisibleLineDrawingRemainder) / textArea.TextView.FontHeight + 1; ++y) {
				...
				if (rect.IntersectsWith(markerRectangle)) {
					...
					if (textArea.Document.SyntaxProperties.ShowLineNumbers) {
		...
		{
			bool  showFolding  = textArea.Document.SyntaxProperties.EnableFolding;
