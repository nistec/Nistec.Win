...
namespace Nistec.SyntaxEditor.UI
{
	...
	public class GutterMargin : AbstractMargin
	{
		...
		static GutterMargin()
		{
            Stream cursorStream = Assembly.GetCallingAssembly().GetManifestResourceStream("Nistec.SyntaxEditor.data.RightArrow.cur");
		...
		public override bool IsVisible {
			get {
				return textArea.SyntaxProperties.ShowLineNumbers;
			}
		}
