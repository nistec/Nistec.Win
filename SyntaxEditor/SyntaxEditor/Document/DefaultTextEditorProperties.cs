...
namespace Nistec.SyntaxEditor.Document
{
    ...
    public class DefaultSyntaxProperties /*DefaultTextEditorProperties*/ : ISyntaxProperties
	{
		int                   tabIndent             = 4;
		...
		bool        showSpaces          = false;//true;
		bool        showTabs            = false;//true;
		bool        showEOLMarker       = false;//true;
		
		bool        showInvalidLines    = false;//true;
		
		bool        isIconBarVisible    = true;
		bool        enableFolding       = true;
		bool        showHorizontalRuler = false;
		bool        showVerticalRuler   = false;//true;
