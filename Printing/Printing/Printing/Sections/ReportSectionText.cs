...
//	/// </para>
//	/// </remarks>
    public class ReportSectionText : ReportSection
	{
        ...
        public ReportSectionText(string text, TextStyle textStyle)
        {
            this.Text = text;
        ...
        public virtual HorizontalAlignment ConvertAlign(StringAlignment stringAlign)
        {
        ...
        public virtual StringAlignment ConvertAlign(HorizontalAlignment stringAlign)
        {
        ...
        /// this call to Print()
        /// </summary>
        /// <param name="printDocument">The parent McPrintDocument.  
        ...
        protected virtual string GetText (McPrintDocument printDocument)
        {
        ...
        /// </summary>
        /// <param name="printDocument">Pparent McPrintDocument that is printing.</param>
            ...
            )
        {
            ...
            if (CheckTextLayout(g))
            {
                ...
                textToPrint = GetText(printDocument);
                retval = SetTextSize (printDocument, g, bounds, true);
            }
            else
            {
                retval.Fits = false;
        ...
        /// </summary>
        /// <param name="doc">The parent McPrintDocument</param>
        /// <param name="g">Graphics object</param>
        /// <param name="bounds">Bounds to draw within</param>
        /// <param name="sizeOnly">Only size</param>
        /// <returns>SectionSizeValues</returns>
        SectionSizeValues SetTextSize (McPrintDocument doc, Graphics g, Bounds bounds, bool sizeOnly)
        {
            SectionSizeValues retval = new SectionSizeValues();
            retval.Fits = true;
