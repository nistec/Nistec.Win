...
namespace Nistec.Printing.Sections
{
    ...
    public abstract class SectionContainer : ReportSection
    {
        ...
        /// </summary>
        internal protected int sectionIndex;
...
//        public virtual int AddSection (ReportSection section)
//        {
//            Debug.WriteLineIf (!UseFullWidth, "Recommended to set UseFullWidth if specifying HorizontalAlignment");
//            Debug.WriteLineIf (!UseFullHeight, "Recommended to set UseFullHeight if specifying VerticalAlignment");
//            return this.sections.Add(section);
//        }
