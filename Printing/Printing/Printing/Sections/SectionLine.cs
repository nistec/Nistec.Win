...
//    /// </remarks>
    public class SectionLine : ReportSection
	{
        ...
        /// <summary>
        /// Sets the default pen to the NormalPen used by printDocument
        /// </summary>
        /// <param name="printDocument">Parent McPrintDocument</param>
        protected virtual void SetDefaultPen (McPrintDocument printDocument)
        {
            if (this.pen == null)
            {
                this.pen = printDocument.NormalPen;
            }
        }
        ...
        {
//            Debug.WriteLine("ReportSectionLine DoCalcSize");
//            Debug.WriteLine("   Bounds: " + bounds.ToString());

            SetDefaultPen (printDocument);
        ...
        {
//            Debug.WriteLine("ReportSectionLine DoPrint");
//            Debug.WriteLine("   Bounds: " + bounds.ToString());
