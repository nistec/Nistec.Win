...
//	/// </para>
//    /// </remarks>
    public class LinearSections : SectionContainer
	{
        /// <summary>
        /// Constructor
        /// </summary>
...
//		/// </summary>
        ...
        /// </summary>
        /// <param name="printDocument">Parent McPrintDocument</param>
...
//            Debug.WriteLine("   Bounds: " + bounds);
            ...
            {
                CurrentSection.CalcSize (printDocument, g, bounds);
                if (CurrentSection.Fits)
                {
                    retvals.Fits = true;
                    if (!sizeOnly) CurrentSection.Print (printDocument, g, bounds);
...
//            Debug.WriteLine("   Size: " + RequiredSize);
            ...
            )
        {
            ...
            return SizePrintLine (printDocument, g, bounds, true, false);
        }
        ...
        {
            bounds = bounds.GetBounds (this.RequiredSize);
            
            SizePrintLine (printDocument, g, bounds, false, true);
        }
