...
//	/// </para>
//	/// </remarks>
	public class SectionBox : ReportSection
	{
        ...
        Bounds GetMaxContentBounds (Bounds bounds)
        {
            ...
            if (Width > 0)
            {
                float contentWidth = Width - MarginLeft - MarginRight
            ...
            if (Height > 0)
            {
                float contentHeight = Height - MarginTop - MarginBottom
            ...
            )
        {
            ...
            if (Content != null)
            {
                Content.CalcSize (printDocument, g, GetMaxContentBounds(bounds));
                contentSize = Content.Size; // or could use RequiredSize?
            }
            ...
            )
        {
            ...
            if (Content != null)
            {
                Content.Print (printDocument, g, this.contentBounds);
            }
        }
