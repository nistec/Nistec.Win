...
//    /// <seealso cref="Nistec.Printing.ReportSectionText"/>
//    /// <seealso cref="Nistec.Printing.ReportSectionData"/>
//    /// </para>
//    /// <para>
    ...
    public abstract class ReportSection
    {
            ...
            Bounds bounds)
        {
            ...
            else if (!this.sized)
            {
                ...
                SectionSizeValues vals = DoCalcSize(printDocument, g, this.sizingBounds);
            ...
            Bounds bounds)
        {
            ...
            CalcSize (printDocument, g, bounds);
            if (this.fits)
            {
                DoPrint (printDocument, g, printingBounds);
            }
            ResetSize ();
        }
