...
//    /// </remarks>
    public class TextStyle
    {
        ...
        static TextStyle()
        {
            ...
            TableHeaderCentered = new TextStyle(TableHeader);
            TableRowCentered = new TextStyle(TableRow);
            TableHeaderRight = new TextStyle(TableHeader);
            TableRowRight = new TextStyle(TableRow);
        ...
        /// <summary>
        /// The TextStyle used by the header row of a table
        /// if centered justification is desired
        /// It defaults to TableHeader + StringAlignment=Center
        /// </summary>
        public static readonly TextStyle TableHeaderCentered;
        /// <summary>
        /// The TextStyle used by the rows of data of a table.
        /// if centered justification is desired
        /// It defaults to TableRow + StringAlignment=Center
        /// </summary>
        public static readonly TextStyle TableRowCentered;
        /// <summary>
        /// The TextStyle used by the header row of a table.
        /// if right justification is desired
        /// It defaults to TableHeader + StringAlignment=Right
        /// </summary>
        public static readonly TextStyle TableHeaderRight;
        /// <summary>
        /// The TextStyle used by the rows of data of a table.
        /// if right justification is desired
        /// It defaults to TableRow + StringAlignment=Right
        /// </summary>
        public static readonly TextStyle TableRowRight;
        /// <summary>
        ...
        public static void ResetStyles()
        {
            ...
            PageHeader.MarginTop = 0f;
            PageHeader.MarginBottom = 0.15f;
            ...
            PageFooter.MarginTop = 0.15f;
            PageFooter.MarginBottom = 0f;

            TableHeader.ResetToDefault();
            TableHeader.Bold = true;
            TableHeader.MarginBottom = 0f;

            TableRow.ResetToDefault();
            TableRow.MarginBottom = 0f;

            TableHeaderCentered.ResetToDefault();
            TableHeaderCentered.StringAlignment = StringAlignment.Center;
            TableHeaderRight.ResetToDefault();
            TableHeaderRight.StringAlignment = StringAlignment.Far;
            TableRowCentered.ResetToDefault();
            TableRowCentered.StringAlignment = StringAlignment.Center;
            TableRowRight.ResetToDefault();
            TableRowRight.StringAlignment = StringAlignment.Far;
        ...
        /// based from.
        /// </summary>
        /// <param name="defaultStyle">A default <see cref="Nistec.Printing.TextStyle"/>
        ...
        /// <summary>
        /// Gets or sets the the font size (in points) of this style.
        /// </summary>
        public float Size
        {
            get
        ...
        /// </summary>
        /// <remarks>
        /// Currently hardcoded to use StringFormatFlags.LineLimit and
