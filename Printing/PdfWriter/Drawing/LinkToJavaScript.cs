namespace MControl.Printing.Pdf.Drawing
{
    ...
    public class LinkToJavaScript : GraphicsElement
    {
        private string _b0;
        private float _b1;
        private float _b2;
        ...
        public LinkToJavaScript(string script, float x, float y)
        {
            this.b6(script, x, y, 0f, 0f);
        }

        public LinkToJavaScript(string script, float x, float y, float width, float height)
        {
            this.b6(script, x, y, width, height);
        }

        public LinkToJavaScript(string script, float x, float y, float width, float height, string name)
        {
            base._A154 = name;
            this.b6(script, x, y, width, height);
        }
