namespace MControl.Printing.Pdf.Drawing
{
    ...
    public class Rectangle : GraphicsElement
    {
        ...
        public Rectangle(float x, float y, float width, float height, float linewidth, MControl.Printing.Pdf.LineStyle linestyle, PdfColor linecolor, PdfColor fillcolor, MControl.Printing.Pdf.GraphicsMode mode, string name)
        {
            this._b0 = x;
            this._b1 = y;
            this._b2 = width;
        ...
        internal override void A119(ref A120 b9, ref A112 b10)
        {
            ...
            GraphicsElement.A437(b10, this._b0, b9.A98(this._b1), this._b2, this._b3);
