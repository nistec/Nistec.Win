namespace MControl.Printing.Pdf.Core.Drawing
{
    ...
    internal class A509 : GraphicsElement
    {
        private float _b0;
        private float _b1;
        private float _b2;
        ...
        internal A509(float b0, float b1, float b2, float b3)
        {
            this._b0 = b0;
            this._b1 = b1;
            this._b2 = b2;
        ...
        {
            GraphicsElement.A512(this._b0, this._b1, this._b2, this._b3, ref b4, ref b5);
        }
