namespace MControl.Printing.Pdf.Core.Fonts
{
    ...
    internal class A276 : A252
    {
        internal A276()
        {
            base._A247 = "HeiseiKakuGo-W5";
            base._A253 = 0x36b;
            base._A254 = 0x7d;
            base._A255 = 3;
        ...
        internal override void A54(ref A55 b3)
        {
            ...
            b3.A59("/BaseFont/HeiseiKakuGo-W5");
            b3.A59("/Encoding/UniJIS-UCS2-H");
            ...
            b3.A54("/Ordering ");
            A26.A54(ref b3, "Japan1", A);
            b3.A59("/Supplement 2 >>");
            b3.A59(string.Format("/FontDescriptor {0} 0 R", base.A95 + 2));
            b3.A59("/W[1 95 500 231 632 500]");
            b3.A59("/DW 1000");
            b3.A59(">>");
            b3.A59("endobj");
            A2.A94(b3.A2, 0);
            ...
            b3.A59("/FontBBox[-92 -250 1010 922]");
            b3.A59(">>");
            b3.A59("endobj");
        }
    }
