...
namespace mControl.WinCtl.Controls
{
	...
	///	</summary>
	[Designer(typeof(Design.CtlEditDesigner))]
	[ToolboxItem(false)]
	//[ToolboxBitmap(typeof(CtlListViewGrid), "Toolbox.ListViewGrid.bmp")]
	internal class CtlListViewGrid	: CtlListView
	{
