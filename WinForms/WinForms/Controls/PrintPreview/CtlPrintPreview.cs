...
using MControl.WinForms.Printing;

namespace MControl.WinForms
{

	[ToolboxBitmap (typeof(McPrintPreview), "Toolbox.Preview.bmp"),ToolboxItem(true), DefaultProperty("Document")]
	public class McPrintPreview : McControl //Control
	{
		// Events
...
//			MControl.Win32.RECT rect1 =  MControl.Win32.RECT(rectangle1.X, rectangle1.Y, rectangle1.Width, rectangle1.Height);
//			MControl.Win32.sScrollWindow(new HandleRef(this, base.Handle), point1.X - this.position.X, point1.Y - this.position.Y, ref rect1, ref rect1);
