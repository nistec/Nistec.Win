...
namespace mControl.WinForms.Design
{
    internal class TabPagesDesigner : ParentControlDesigner
    {
        ...
        protected override bool GetHitTest(Point point)
        {
            ...
            McPage page1 = this.tabControl.GetTabPageAtPoint(this.tabControl.PointToClient(point));
            return (page1 != null);
        }
        ...
        public override void Initialize(IComponent component)
        {
            ...
            this.tabControl = (McTabPages)base.Control;
        }
        ...
        private void OnAdd(object sender, EventArgs e)
        {
            try
            {
                ...
                McPage page1 = (McPage)host1.CreateComponent(typeof(McPage));
        ...
        private void OnRemove(object sender, EventArgs eevent)
        {
            if ((this.tabControl != null) && (this.tabControl.TabPages.Count != 0))
            {
                ...
                McPage page1 = this.tabControl.SelectedTab;
        ...
        protected override void WndProc(ref Message msg)
        {
            if (msg.Msg == 0x201)
            {
                ...
                McPage page1 = this.tabControl.GetTabPageAtPoint(point1);
                if (page1 != null)
                {
