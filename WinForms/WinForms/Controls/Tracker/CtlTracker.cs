...
namespace mControl.WinCtl.Controls
{
	...
	[ToolboxBitmap (typeof(CtlTracker),"Toolbox.Tracker.bmp")]
	public class CtlTracker : System.Windows.Forms.UserControl
	{
		#region Members
		/// <summary> 
		...
		Color MyBackColor = SystemColors.AppWorkspace;
		...
		/// Cunstructor
		/// </summary>
		/// <param name="theControl">The Control we want to use the CtlTracker on</param>
		public CtlTracker(Control theControl)
		{
