...
namespace mControl.WinCtl.Controls
{
		...
		{	
			...
			protected void ParseEditText()
			{
				try
				{
					DateTime d=Util.Types.DateFromString(this.Text,CultureInfo.CurrentCulture);
					m_Value=Util.Types.DateFromString(this.Text,CultureInfo.CurrentCulture);
					//if(this.RangeValue.IsValid(this.Text))
					//{
					//Value =DateTime.Parse(this.Text, CultureInfo.CurrentUICulture);
					//}
				}
				catch (Exception)
				{
			...
			public void AppendDateText(string value)
			{
				try
				{
					AppendDateText(DateTime.Parse(value));
				}
				catch(Exception)
				{
