...
namespace Nistec.WinForms
{
    ...
    Designer(typeof(McHelpLabel.HelpLabelDesigner))]
	[ToolboxItem(true),ToolboxBitmap(typeof(McHelpLabel), "Toolbox.HelpLabel.bmp")]
	public class McHelpLabel : McControl, System.ComponentModel.IExtenderProvider 
	{
		...
		// <doc>
		// <desc>
		//      This is the extended property for the StatusText property.  Extended
		...
		//
		[DefaultValue("")]
		public string GetStatusText(Control control) 
		{
		...
		// <doc>
		// <desc>
		//      This is the extended property for the StatusText property.
		// </desc>
		// </doc>
		//
		public void SetStatusText(Control control, string value) 
		{
			if (value == null) 
			{
				value = string.Empty;
		...
		protected override void OnPaint(PaintEventArgs pe) 
		{
			...
			// Draw a rectangle around control.
			//
			Rectangle rect = ClientRectangle;

			Pen borderPen = new Pen(borderColor);
			pe.Graphics.DrawRectangle(borderPen, new Rectangle( rect.X,rect.Y,rect.Width-1,rect.Height-1));
			borderPen.Dispose();
		...
		#region Class HelpLabelDesigner
		//
		// <doc>
		// <desc>
		//      This is a designer for the McStatusMonitor.  This designer provides
        ...
        internal class HelpLabelDesigner : System.Windows.Forms.Design.ControlDesigner 
		{
			...
			private bool TrackSelection
			{
				...
				set
				{
					...
					if (trackSelection)
					{
						...
						if (ss != null)
						{
							UpdateStatusLabelSelection(ss);
						}
					}
					else
					{
                        McHelpLabel helpLabel = (McHelpLabel)Control;
			...
			/// </summary>
			/// <param name="ss"></param>
			private void UpdateStatusLabelSelection(ISelectionService ss)
			{
