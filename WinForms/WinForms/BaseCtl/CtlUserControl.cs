...
namespace Nistec.WinForms.Controls
{
	...
	public  class McCustomControl : System.Windows.Forms.UserControl,ILayout,IBind
	{
		...
		public McCustomControl()
		{	
			autoChildrenStyle=true;
			InitializeComponent();
		}

        internal McCustomControl(bool net)
		{	
			InitializeComponent();
			m_netFram=net;
		}
