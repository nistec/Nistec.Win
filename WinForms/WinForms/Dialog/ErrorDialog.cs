...
namespace Nistec.WinForms
{
	...
	public class ErrorDialog : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Label lblValidMessage;
		...
		private void InitializeComponent()
		{
            ...
            this.lblValidMessage = new System.Windows.Forms.Label();
            ...
            this.btOk.Location = new System.Drawing.Point(289, 66);
            this.btOk.Name = "btOk";
            ...
            // lblValidMessage
            // 
            this.lblValidMessage.Location = new System.Drawing.Point(48, 12);
            this.lblValidMessage.Name = "lblValidMessage";
            this.lblValidMessage.Size = new System.Drawing.Size(316, 48);
            this.lblValidMessage.TabIndex = 2;
            this.lblValidMessage.Text = "Message ....";
            this.lblValidMessage.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // linkDetails
            // 
            this.linkDetails.AutoSize = true;
            this.linkDetails.Location = new System.Drawing.Point(4, 76);
            ...
            // textDetails
            // 
            this.textDetails.Location = new System.Drawing.Point(7, 104);
            ...
            this.textDetails.Size = new System.Drawing.Size(357, 151);
            ...
            this.Controls.Add(this.lblValidMessage);
        ...
        private bool detailsShow = false;
		...
		public ErrorDialog(Exception p_Exception, string p_Caption):this()
		{
            ...
            this.textDetails.Text = Exception.StackTrace;
            this.lblValidMessage.Text = Exception.Message;
		}
		...
		private void linkDetails_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			try
			{
                this.Height = detailsShow ? 130 : 300;
                detailsShow = !detailsShow;
                this.linkDetails.Text = detailsShow ? "None" : "Details";
		...
		private void ErrorDialog_Load(object sender, System.EventArgs e)
		{
			...
			{
				if (m_Exception != null)
					lblValidMessage.Text = m_Exception.Message;
				else
					lblValidMessage.Text = "Exception is null";
			}
			catch(Exception err)
			{
				lblValidMessage.Text = "Error loading message:" + err.Message;
			}		
		}
