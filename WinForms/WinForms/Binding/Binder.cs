...
namespace Nistec.WinForms
{
	...
	public class Binder : Binding
	{
		...
		internal void SetControl(McBind value)
		{
		    if (this.Control != value)
		    {
		        McBind control1 = this.control;
		        ...
		        BindContext.UpdateBinding(((this.Control != null) && this.Control.Created) ? ((McBind)this.Control).BindContext : null, this);
	...
	public class ControlBindCollection : BindCollectionBase
	{
		...
		internal ControlBindCollection(McBind control)
		{
