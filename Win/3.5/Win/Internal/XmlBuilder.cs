...
namespace MControl
{
    ...
    /// </summary>
    internal class XmlBuilder : IDisposable
    {
        ...
        ///// </summary>
        ///// <param name="xNode"></param>
        //public void AppendElement(XmlNode xNode)
        //{
        ...
        //{
        //    XmlNode elm = doc.CreateNode(XmlNodeType.Element, Name, "");

        //    //return doc.AppendChild(elm);
        //}
        ...
        //{
        //    XmlNode elm = doc.CreateNode(XmlNodeType.EndElement, Name, "");
        //    //doc.AppendChild(elm);
        //}
        /// <summary>
        ...
        public void AppendAttribute(XmlNode xNode,string Name, string Value)
        {
            XmlAttribute attribute = doc.CreateAttribute(Name);
            attribute.Value = Value;
            //xNode.DocumentElement.SetAttributeNode(attribute);
