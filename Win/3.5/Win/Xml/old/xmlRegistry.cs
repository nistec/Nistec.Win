...
namespace mControl.Xml
{
	...
	/// It needs to directly access the API 
	/// </summary>
	public class xmlRegistry
	{
		...
		public static RegistryKey openKey(RegistrySection strMainKey, string strPath)
		{
			return openKey(strMainKey.ToString(),strPath);
		}
