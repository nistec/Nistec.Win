...
namespace MControl.Xml
{
    ...
    public class XmlParser : IDisposable
    {
        ...
        ///// <summary>
        ///// Validate Xml Node, raise XmlException if no valid
        ///// </summary>
        ///// <param name="node"></param>
        //public void ValidateXmlNode(XmlNode node)
        //{
        //    ValidateXmlNode(node, true);
        //}
        ///// <summary>
        ///// Validate Xml Attribute, raise XmlException if no valid
        ///// </summary>
        ///// <param name="attrib"></param>
        //public void ValidateXmlAttribute(XmlAttribute attrib)
        //{
        //    ValidateXmlAttribute(attrib, true);
        //}
