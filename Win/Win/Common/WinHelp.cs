...
namespace Nistec
{
    public static class WinHelp
    {
        ...
        public static string ParseToCurrency(string Txt, decimal defaultValue, int decimalPlaces=2)
        {
            string txt = WinRegx.ParseCurrencyToNumber(Txt, defaultValue);
            if (txt.Length > 0)
            {
        ...
        {
            string txt = WinRegx.ParseCurrencyToNumber(Txt);
            if (txt.Length > 0)
            {
                return decimal.Parse(txt).ToString("C" + decimalPlaces.ToString(), CultureInfo.CurrentCulture);
            }
        ...
        public static string ParseCurrencyToNumber(string Txt, decimal DefaultValue)
        {
            ...
            return WinRegx.ParseCurrencyToNumber(Txt,DefaultValue);
       }
        #endregion
