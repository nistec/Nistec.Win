...
namespace Nistec.Collections
{
    ...
    public class CollectionWithEvents : CollectionBase
    {
        ...
        /// <param name="value">The Item that was removed from the <see cref="T:Nistec.Charts.ParameterCollection"></see>. </param>
        ...
        ///// <exception cref="T:System.ArgumentException">The object is not an instance of the <see cref="T:Nistec.Charts.KeyItem"></see> class or one of its derived classes. </exception>
