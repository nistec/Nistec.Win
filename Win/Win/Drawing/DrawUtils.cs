...
namespace Nistec.Drawing
{
	...
	/// See also Nistec.Drawing.Utilities.FillRoundedRectangle and DrawRoundedRectangle methods.
	/// </summary>
...
//		}
		...
		{			
			//return Type.GetType("Nistec.ResourceUtils").Assembly.GetManifestResourceStream("Nistec.WinForms." + imageName);
		...
		public static Image ExtractImage(string p_Image)
		{
			...
			//return Image.FromStream(l_as.GetManifestResourceStream("Nistec.WinForms.Images." + p_Image));
		}
...
//		}
		...
		{			
			...
			Stream strm = Type.GetType("Nistec.Drawing.ResourceUtils").Assembly.GetManifestResourceStream(imageName);
			//Stream strm = Type.GetType("Nistec.ResourceUtils").Assembly.GetManifestResourceStream("Nistec.WinForms.Images." + imageName);
		...
		{			
			...
			Stream strm = Type.GetType("Nistec.Drawing.ResourceUtils").Assembly.GetManifestResourceStream(iconName);
			//Stream strm = Type.GetType("Nistec.ResourceUtils").Assembly.GetManifestResourceStream("Nistec.WinForms.Images." + iconName);
