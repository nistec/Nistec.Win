<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sample7.aspx.cs" Inherits="Sample7" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Mc:McGraph ID="mcWebChart" runat="server" ChartType="Surface" AxisLabelFont="Arial, 12pt"
