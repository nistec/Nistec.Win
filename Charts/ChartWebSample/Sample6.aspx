<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sample6.aspx.cs" Inherits="Sample6" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Mc:McGraph ID="mcWebChart" runat="server" ChartType="Pipes" AxisLabelFont="Arial, 12pt"
