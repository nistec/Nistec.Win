<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sample3.aspx.cs" Inherits="Sample3" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Mc:McGraph ID="mcWebChart" runat="server" ChartType="BarsMulti3D" AxisLabelFont="Arial, 12pt"
