<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Sample1.aspx.cs" Inherits="Sample1" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Mc:McGraph ID="mcWebChart" runat="server" ChartType="Bars" AxisLabelFont="Arial, 12pt"
