<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Sample2.aspx.cs" Inherits="Sample2" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <Mc:McGraph ID="mcWebChart" runat="server" ChartType="Bars3D" AxisLabelFont="Arial, 12pt"
