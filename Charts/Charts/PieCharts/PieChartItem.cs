...
namespace Nistec.Charts
{
  ...
  public partial class PieChartItem : ICloneable, ISerializable, IComparable<PieChartItem>
  {
    ...
    /// <summary>
    /// The panel item text description  .
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the panel text displayed .
    /// </summary>
    [Browsable(true)]
    [DefaultValue("")]
    [Description("The text that will be placed in a panel description.")]
    ...
    #region Methods
      ...
      /// <summary>
      /// get text description from panel text or text if is empty
      /// </summary>
      /// <returns></returns>
      public string GetPanelText()
      {
          return string.IsNullOrEmpty(panelText) ? text : panelText;
      }
    ...
    /// <param name="control">The control that contains this item.</param>
      internal void SetOwner(McPieChart control)
    {
