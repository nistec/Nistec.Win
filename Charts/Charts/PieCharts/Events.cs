...
{
    public delegate void PieChartItemEventHandler(object sender, McPieChart.PieChartItemEventArgs e);
    public delegate void PieChartItemFocusEventHandler(object sender, McPieChart.PieChartItemFocusEventArgs e);
    ...
    public partial class McPieChart : Control
  {
    ...
    /// <summary>
    /// Fired when the leaning of the control has changed.
    /// </summary>
    public event EventHandler LeaningChanged;
    ...
    /// <summary>
    /// Fired when the depth of the control has changed.
    /// </summary>
    ...
    /// <summary>
    /// Called to fire an LeaningChanged event.
    /// </summary>
    internal void FireLeaningChanged()
    {
      if (LeaningChanged != null)
        LeaningChanged(this, EventArgs.Empty);
    }
    ...
    /// <summary>
    /// Called to fire an DepthChanged event.
    /// </summary>
    internal void FireDepthChanged()
    {
