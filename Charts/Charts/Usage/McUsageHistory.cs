...
{
	/// <summary>
	/// Summary description for McUsageHistory.
	/// </summary>
    [ToolboxBitmap(typeof(McUsageHistory), "Images.UsageHistory.bmp")]
    public class McUsageHistory : System.Windows.Forms.UserControl
	{
		/// <summary> 
