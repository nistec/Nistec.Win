...
namespace MControl.Charts
{
    ...
    //    {
    //        DataTable chartTable = GroupByHelper.DoSelectGroupByInto(mode, dataSource, tableName, groupByField, sumField, aliasSumField, filter);
    ...
    //        this.graph.DataItems.Add(new MControl.Charts.DataItem(sumField));
    ...
    public partial class GraphControl : UserControl
    {
        ...
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Quarter1"));
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Quarter2"));
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Quarter3"));
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Quarter4"));
        //    this.graph.KeyItems.Clear();
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Ouarter1"));
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Ouarter2"));
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Ouarter3"));
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Ouarter4"));

        //    this.graph.ColorItems.Clear();
        //    this.graph.ColorItems.Add(new MControl.Charts.ColorItem(Color.Red));
        //    this.graph.ColorItems.Add(new MControl.Charts.ColorItem(Color.Blue));
        //    this.graph.ColorItems.Add(new MControl.Charts.ColorItem(Color.Gold));
        //    this.graph.ColorItems.Add(new MControl.Charts.ColorItem(Color.Green));
        //    this.graph.ColorItems.Add(new MControl.Charts.ColorItem(Color.Violet));
        ...
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Total1996"));
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Total1997"));
        //    this.graph.DataItems.Add(new MControl.Charts.DataItem("Total1998"));
        //    this.graph.KeyItems.Clear();
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Total1996"));
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Total1997"));
        //    this.graph.KeyItems.Add(new MControl.Charts.KeyItem("Total1998"));
