namespace Nistec.Charts
{
    ...
    {
        #region members
        internal int alpha = 0x9b;
        internal bool AutoPostBack = true;
        internal Font AxisLabelFont = new Font("Arial", 12f);
        internal Color BackColor = Color.White;
        internal Color ChartBackColor = Color.White;
        internal int BackgroundDarkening = 20;
        internal ColorItemCollection col = new ColorItemCollection();
        internal DataTable data;
        internal double pieHole = 0.3;
        internal bool DrawGrid = true;
        internal int effect;
        internal double effectopacity = 0.1;
        internal double slicesOffset = 0.05;
        internal Color ForeColor = Color.White;
        internal string FieldCategory = "";
        internal string FieldID = "";
        internal string ImageFolder = "ChartTemp";
        internal Font FieldLabelFont = new Font("Arial", 8f);
        internal string LabelsFormatString = "{0}";
        internal int height;
        internal int LineGraphsDataPointSize = 5;
        internal int LineGraphsLineSize = 4;
        internal string mapXml = "";
        internal string mapXMlPath = string.Empty;
        internal Font KeyFont = new Font("Arial", 8f);
        internal KeyItemCollection KeyLabels = new KeyItemCollection();
        internal double Percent3D = 0.5;
        internal double PercentWidth = 0.8;
        internal ImageItemCollection pointImages = new ImageItemCollection();
        internal string radacina;
        internal int realShadowOffsetX =5;// 15;
        internal int realShadowOffsetY =-15;// -25;
        internal int ScaleBreakHeightV = 5;
        internal decimal ScaleBreakMaxV;
        internal decimal ScaleBreakMinV;
        internal bool ShadowIsDrawn = true;
        internal bool ShowRecursionEquations;
        internal string Title = "Chart Title";
        internal Font TitleFont = new Font("Arial", 16f);
        //internal int type;
        internal ChartType type;
        internal string userImage = string.Empty;
        internal string userImagePath = string.Empty;
        internal Font ValueLabelsFont = new Font("Arial", 8f);
        internal string ValueLabelsFormatString = string.Empty;
        internal int width;
        internal DataItemCollection dataItems = new DataItemCollection();
        internal string XAxisLabels = "label";
        internal string XName = "Axis Label X";
        internal string YName = "Axis Label Y";
        internal bool ShouldSerializeState=false;// SessionStateMode = "InProcess";
        ...
        internal ChartFlash flash = new ChartFlash();
        private int graphHeight;
        private int graphstartsY;
        private int graphWidth;
        internal decimal lat1 = -90M;
        internal decimal lat2 = 90M;
        private static string LicenseText ="...TRIAL VERSION...";// "Un Licensed";// "Not for production environment";
        ...
        internal ImageItemCollection pointImagesReal = new ImageItemCollection();
        private string rez;
        ...
        //internal object WinCustomImage;
        private XmlChart xmlChart;

        #endregion

        private void SetHotSpotCollection(ChartHotSpotCollection spots)
        {
            if (ShouldSerializeState)
            {
                HttpContext.Current.Session[this.rez] = NetSerializer.SerializeToBase64(spots);

                //HttpContext.Current.Session[this.rez] = SessionChart.Serialize(spots);
            }
            else
            {
        ...
        private bool ValidateLicense()
        {
            ...
            {
                return this.ValidateWebLicense();
            }
            return ((this.colectieHotspoturi == null) || this.ValidateWinLicense());
        }
        ...
        private bool ValidateWebLicense()
        {

            return true;

            //string s = string.Empty;
            //if (HttpContext.Current.Application["McChartsLicense"] != null)
            //{
            //    s = (string)HttpContext.Current.Application["McChartsLicense"];
            //}
            //else
            //{
            //    bool ok=Nistec.Net.ChartNet.GetNetFram("WEB");
            //    if (ok)
            //    {
            //        s = Nistec.Net.ChartNet.McLic;
            //        HttpContext.Current.Application["McChartsLicense"] = s;
            //    }
            ...
            //return s == Nistec.Net.ChartNet.McLic; 
        }

        private bool ValidateWinLicense()
        {
            return true;
            //return Nistec.Net.ChartNet.GetNetFram("WEB");
            ...
            //else
            //{
            //    FileInfo info = new FileInfo("McChartsLicense.lic");
            //    if (info.Exists)
            //    {
            //        s = File.ReadAllText(info.FullName);
            //        licenta = s;
        ...
        private int ComputeXAxisSpace(Graphics g, int width)
        {
            ...
            Font labelsFont = this.FieldLabelFont;
        ...
        public Bitmap Draw()
        {
            ...
            graphics.FillRectangle(new SolidBrush(this.ChartBackColor), -5, -5, this.width + 10, this.height + 10);
            this.xmlChart.AddBar(this.height + 10, this.width + 10, -5f, -5f, new ColorItem(this.ChartBackColor).ToString(), this.ChartBackColor.A, 0, 0, string.Empty, null);
            ...
            switch (this.type)
            {
                case ChartType.Bars:// 0:
                    bitmap3 = this.DrawBars();
                    break;

                case ChartType.Pie:// 1:
                    bitmap3 = this.DrawPie();
                    break;

                case ChartType.Bars3D:// 2:
                ...
                case ChartType.BarsMulti:// 4:
                    bitmap3 = this.DrawMultiBars();
                    break;

                case ChartType.Line:// 5:
                    bitmap3 = this.DrawLine();
                    break;

                case ChartType.LineMulti:// 6:
                    bitmap3 = this.DrawMultiLine();
                    break;

                case ChartType.BarsStack:// 7:
                ...
                case ChartType.BarsMulti3D:// 11:
                    bitmap3 = this.DrawMultiBars3D();
                    break;

                case ChartType.Pipes:// 12:
                    bitmap3 = this.DrawCylinders();
                    break;

                case ChartType.Pie3D:// 13:
                    bitmap3 = this.Draw3DExplodedPieOrDonauht(0.0, 0.0);
                    break;

                case ChartType.Surface:// 14:
                    bitmap3 = this.DrawSurface();
                    break;

                case ChartType.SurfaceMulti:// 15:
                    bitmap3 = this.DrawMultiSurface();
                    break;

                //case ChartType.CustomMap:// 0x10:
                //    bitmap3 = this.DrawMap();
                //    break;

                case ChartType.PieExpanded:// 0x11:
                ...
                case ChartType.SurfaceStack:// 0x19:
                ...
                case ChartType.LineMulti3D:// 0x1b:
                    bitmap3 = this.DrawMulti3DLine();
                    break;

                case ChartType.LineCurveMulti:// 0x1c:
                    bitmap3 = this.DrawMultiCurve();
                    break;

                //case ChartType.PieExpanded:// 0x1d:
                //    bitmap3 = this.Draw3DExplodedPieOrDonauht(this.explosion, 0.0);
                //    break;

                case ChartType.PieExpanded3D:// 30:
                    bitmap3 = this.Draw3DExplodedPieOrDonauht(this.slicesOffset, this.pieHole);
                    break;

                //case ChartType.CustomMapPoints:// 0x1f:
                //    bitmap3 = this.DrawMapPoints();
                //    break;

                case ChartType.BarsWide3D:// 0x20:
                    bitmap3 = this.DrawWideBars3D();
                    break;

                case ChartType.PipesStack:// 0x21:
                ...
                case ChartType.PipesMulti:// 0x23:
                    bitmap3 = this.DrawMultiCylinders();
                    break;

                case ChartType.Surface3D:// 0x24:
                    bitmap3 = this.DrawSurface3D();
                    break;

                case ChartType.SurfaceMulti3D:// 0x25:
                    bitmap3 = this.DrawMultiSurface3D();
                    break;

                case ChartType.SurfaceStack3D:// 0x26:
            ...
            if (!this.ValidateLicense())
            {
                ...
                Brush brush2 = new SolidBrush(Color.FromArgb(200, Color.Black));
        ...
        private bool ValidateData(bool throwOnError )
        {
            throwOnError = true;
            if (this.data == null)
            {
                if (throwOnError)
                    ChartValidation.ThrowNoData();
                return false;
            }
            if (this.dataItems == null || this.dataItems.Count==0)
            {
                if (throwOnError)
                    ChartValidation.ThrowNoDataItems();
                return false;
            }
            return true;
        ...
        {
            return new Bitmap(this.graphWidth, this.graphHeight);
        }
        ...
        private Bitmap Draw3DExplodedPieOrDonauht(double explosion, double donoughtHole)
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                if (row[this.dataItems[0]] == DBNull.Value)
                {
                    throw new Exception("ERROR: DataItem '" + this.dataItems[0] + "' not found! Check the DataItems property elements or SetDataFields method to set the corect fileds that will appear on the Y axis.");
                }
                if (Convert.ToDouble(row[this.dataItems[0]]) > 0.0)
                {
                    num += Convert.ToDouble(row[this.dataItems[0]]);
                }
            }
            ...
            {
                float num13 = (float) ((Convert.ToDouble(this.data.Rows[i][this.dataItems[0]]) / num) * 360.0);
                if (item < 90f)
                {
                    list.Add(item);
                    list2.Add(num13);
            ...
            List<Charts.ChartLabel> list4 = new List<Charts.ChartLabel>();
            for (int j = 0; j < count; j++)
            {
                ...
                if ((this.ValueLabelsFont != null) && (this.ValueLabelsFormatString != string.Empty))
                {
                    ...
                    list4.Add(new Charts.ChartLabel(text, num58 - (size.Width / 2f), (num59 - (size.Height / 2f)) + 1f, size));
                }
            }
            Charts.ChartLabel.DrawList(list4, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight * 2, 0, 0);
            return image;
        }
        ...
        private Bitmap DrawBars()
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                ...
                if (Convert.ToDecimal(row[this.dataItems[0]]) < lowest)
                {
                    lowest = Convert.ToDecimal(row[this.dataItems[0]]);
                }
                if (Convert.ToDecimal(row[this.dataItems[0]]) > heighest)
                {
                    heighest = Convert.ToDecimal(row[this.dataItems[0]]);
                }
            }
            if (lowest > 0M)
            {
            ...
            ChartHotSpotCollection spots = new ChartHotSpotCollection();
            ...
            List<Charts.ChartLabel> list = new List<Charts.ChartLabel>();
            for (int i = 0; i < count; i++)
            {
                int height = 0;
                try
                {
                    height = Convert.ToInt32((decimal) ((ScaleBreaks.ValRec(this.data.Rows[i][this.dataItems[0]], this.ScaleBreakMin, this.ScaleBreakMax) / (((heighest - lowest) + this.ScaleBreakMin) - this.ScaleBreakMax)) * (this.graphHeight - this.ScaleBreakHeight)));
                }
                catch
                {
                }
                if (height != 0)
                {
                    ...
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, x + ((width - size.Width) / 2f), (y - size.Height) + 1f, size));
                    }
                    ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                    if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                    {
            ...
            {
                ScaleBreaks.DrawScaleBreak(this.xmlChart, g, this.ChartBackColor, this.ScaleBreakPos, this.ScaleBreakHeight, offsetX - 1, this.graphWidth, 0);
            }
            Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, offsetYTop);
            if (HttpContext.Current != null)
            {
                //HttpContext.Current.Session[this.rez] = spots;
                SetHotSpotCollection(spots);
                return bitmap;
            }
        ...
        private Bitmap DrawBars3D()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (height != 0)
                {
                    ...
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, x + ((width - size.Width) / 2f), (y - size.Height) + 0f, size));
                    }
                    ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                    if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                    {
            ...
            if (this.ScaleBreakMax > this.ScaleBreakMin)
            {
                ScaleBreaks.DrawScaleBreak(this.xmlChart, g, this.ChartBackColor, this.ScaleBreakPos, this.ScaleBreakHeight, offsetX - 1, this.graphWidth, depth);
            }
            Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, offsetYTop);
            if (HttpContext.Current != null)
            {
        ...
        private Bitmap DrawCategoryKey()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                if (!list.Contains(this.data.Rows[i][this.FieldCategory].ToString()))
                {
                    list.Add(this.data.Rows[i][this.FieldCategory].ToString());
                    if (this.data.Rows[i][this.FieldCategory].ToString().Length > length)
                    {
                        length = this.data.Rows[i][this.FieldCategory].ToString().Length;
                    }
                    num3 = i;
                }
            }
            ...
            SizeF ef = graphics.MeasureString(this.data.Rows[num3][this.FieldCategory].ToString(), keyFont);
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                if ((this.pointImagesReal.Count == 0) || (ChartMethods.IsTypeInternal(this.type)))// (this.type < 0x1f))
                {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (height != 0)
                {
                    ...
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, x + ((width - size.Width) / 2f), ((y - size.Height) - depth) + 1f, size));
                    }
                    ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                    if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                    {
        ...
        private Bitmap DrawDonought()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                float sweepAngle = (float) ((Convert.ToDouble(this.data.Rows[i][this.dataItems[0]]) / num) * 360.0);
                ...
                if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
                {
                    ...
                    list.Add(new Charts.ChartLabel(text, num9 - (size.Width / 2f), (num10 - (size.Height / 2f)) + 1f, size));
                }
            ...
            Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, 0, 0);
            return bitmap;
        }
        ...
        private Bitmap DrawExplodedPie()
        {
            ...
            this.xmlChart.CurrentPhase = Phase.Elements;
            Pen pen = new Pen(Color.Black);
            int num3 = Convert.ToInt32((double)(Math.Min(this.graphWidth, this.graphHeight) * this.slicesOffset));
            ...
            if (this.ShadowIsDrawn)
            {
                ...
                for (int j = 0; j < count; j++)
                {
                    float sweepAngle = (float) ((Convert.ToDouble(this.data.Rows[j][this.dataItems[0]]) / num) * 360.0);
            ...
            for (int i = 0; i < count; i++)
            {
                float num14 = (float) ((Convert.ToDouble(this.data.Rows[i][this.dataItems[0]]) / num) * 360.0);
                ...
                if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
                {
                    ...
                    list.Add(new Charts.ChartLabel(text, num18 - (size.Width / 2f), (num19 - (size.Height / 2f)) + 1f, size));
                }
                startAngle += num14;
            }
            Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, 0, 0);
        ...
        private Bitmap DrawFullStackedCylinders()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                {
                    num12 += Convert.ToDecimal(this.data.Rows[j][this.dataItems[k]]);
                }
                ...
                for (int m = 0; m < num3; m++)
                {
                    ...
                    try
                    {
                        num18 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / num12) * this.graphHeight));
                    }
                    catch
                    {
                    }
                ...
                for (int n = 0; n < num3; n++)
                {
                    ...
                    try
                    {
                        height = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]) / num12) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]) / num12);
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, x + ((width - size.Width) / 2f), ((y - size.Height) - depth) + 1f, size));
                    }
                    num16 += height;
                    ...
                    spot.PostBackValue = string.Concat(new object[] { this.GetID(j), "|", this.dataItems[n].Name, "|", j });
                    spot.Left = x;
                    spot.Right = x + width;
                    spot.Top = y + this.graphstartsY;
                    spot.Bottom = (y + height) + this.graphstartsY;
        ...
        private Bitmap DrawFullStackedSurface()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    num10 += Convert.ToDecimal(this.data.Rows[i][this.dataItems[j]]);
                }
                decimal num12 = 0M;
                for (int k = 0; k < num4; k++)
                {
                    num12 += Convert.ToDecimal(this.data.Rows[i][this.dataItems[k]]);
                    int num14 = 0;
                    try
                    {
        ...
        private Bitmap DrawLine()
        {
            ...
            else
            {
                ...
                {
                    imageArray[k] = System.Drawing.Image.FromFile(this.pointImagesReal[k].ImageUrl);
                }
            }
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                try
                {
                    num13 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                }
                catch
                {
                }
            ...
            if (this.ValueLabelsFormatString != string.Empty)
            {
                for (int m = 0; m < count; m++)
                {
                    ...
                    try
                    {
                        num18 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[m][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[0]]));
                    SizeF ef = g.MeasureString(text, this.ValueLabelsFont);
        ...
        //{
        //    System.Drawing.Image winCustomImage;
        ...
        //    }
        //    List<string> list = new List<string>();
        //    if (this.FieldCategory != string.Empty)
        //    {
        //        for (int k = 0; k < count; k++)
        //        {
        //            if (!list.Contains(this.data.Rows[k][this.FieldCategory].ToString()))
        //            {
        //                list.Add(this.data.Rows[k][this.FieldCategory].ToString());
        //            }
        //        }
        //    }
        ...
        //    foreach (DataRow row in this.data.Rows)
        //    {
        //        if (Convert.ToDouble(row[this.dataItems[0]]) > minValue)
        //        {
        //            minValue = Convert.ToDouble(row[this.dataItems[0]]);
        //        }
        //    }
        //    Bitmap bitmap = new Bitmap(this.graphWidth, this.graphHeight);
        ...
        //    for (int i = 0; i < count; i++)
        //    {
        //        string key = this.data.Rows[i][this.FieldID].ToString();
        ...
        //            try
        //            {
        //                alpha = Convert.ToInt32((double) ((Convert.ToDouble(this.data.Rows[i][this.dataItems[0]]) / minValue) * 255.0));
        //            }
        //            catch
        //            {
        //            }
        ...
        //            if (this.FieldCategory != string.Empty)
        //            {
        //                int index = list.IndexOf(this.data.Rows[i][this.FieldCategory].ToString());
        ...
        //        list2.Add(map2);
        //    }
        //    if (this.WinCustomImage != null)
        //    {
        //        winCustomImage = this.WinCustomImage as System.Drawing.Image;
        //    }
        //    else
        //    {
        //        winCustomImage = System.Drawing.Image.FromFile(this.userImagePath);
        //    }
        ...
        //    graphics.DrawImage(winCustomImage, new Rectangle(0, 0, this.graphWidth, this.graphHeight), 0, 0, winCustomImage.Width, winCustomImage.Height, GraphicsUnit.Pixel, imageAttr);
        ...
        //        for (int m = 0; m < count; m++)
        //        {
        //            string str2 = this.data.Rows[m][this.FieldID].ToString();
        ...
        //                        SizeF ef = graphics.MeasureString(text, this.FieldLabelFont);
        //                        int num9 = Convert.ToInt32((float) (((((int) row4["X"]) * this.graphWidth) / winCustomImage.Width) - (ef.Width / 2f)));
        //                        int num10 = Convert.ToInt32((float) (((((int) row4["Y"]) * this.graphHeight) / winCustomImage.Height) - ef.Height));
        //                        graphics.DrawString(text, this.FieldLabelFont, brush, new PointF((float) num9, (float) num10));
        //                    }
        //                    if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
        //                    {
        //                        string str4 = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[0]]));
        //                        SizeF ef2 = graphics.MeasureString(str4, this.FieldLabelFont);
        //                        int num11 = Convert.ToInt32((float) (((((int) row4["X"]) * this.graphWidth) / winCustomImage.Width) - (ef2.Width / 2f)));
        //                        int num12 = Convert.ToInt32((int) ((((int) row4["Y"]) * this.graphHeight) / winCustomImage.Height));
        //                        graphics.DrawString(str4, this.FieldLabelFont, brush, new PointF((float) num11, (float) num12));
        //                    }
        ...
        //        }
        //    }
        //    if ((this.WinCustomImage == null) && ((this.userImage == string.Empty) || (this.userImage == null)))
        //    {
        //        try
        //        {
        //            if (!this.windowsControl)
        //            {
        //                winCustomImage = BitmapWriter.Download(this.mapXMlPath, this.graphWidth, this.graphHeight, this.lat1, this.lat2, this.lon1, this.lon2);
        //            }
        //            else
        //            {
        //                winCustomImage = BitmapWriter.WinDownload(this.mapXml, this.graphWidth, this.graphHeight, this.lat1, this.lat2, this.lon1, this.lon2);
        //            }
        //        }
        //        catch
        //        {
        ...
        //        }
        //        graphics = Graphics.FromImage(winCustomImage);
        //        graphics.SmoothingMode = this.smoothingMode;
        //    }
        //    else if (this.WinCustomImage != null)
        //    {
        //        winCustomImage = this.WinCustomImage as Bitmap;
        //        graphics = Graphics.FromImage(winCustomImage);
        //        graphics.SmoothingMode = this.smoothingMode;
        //    }
        //    else
        //    {
        //        winCustomImage = new Bitmap(this.graphWidth, this.graphHeight);
        //        graphics = Graphics.FromImage(winCustomImage);
        //        graphics.SmoothingMode = this.smoothingMode;
        ...
        //        {
        //            imageArray[n] = System.Drawing.Image.FromFile(this.pointImagesReal[n].ImageUrl);
        //        }
        //    }
        //    Brush brush = new SolidBrush(Color.FromArgb(100, Color.Black));
        ...
        //    for (int j = 0; j < count; j++)
        //    {
        //        decimal num7 = Convert.ToDecimal(this.data.Rows[j][this.dataItems[0]]);
        //        decimal num8 = Convert.ToDecimal(this.data.Rows[j][this.dataItems[1]]);
        //        if (num8 > 180M)
        //        {
        //            num8 -= 360M;
        //        }
        //        int num9 = Convert.ToInt32((decimal) ((winCustomImage.Width * (num8 - this.lon1)) / (this.lon2 - this.lon1)));
        //        int num10 = Convert.ToInt32((decimal) ((winCustomImage.Height * (this.lat2 - num7)) / (this.lat2 - this.lat1)));
        //        if (this.ShadowIsDrawn && (imageArray.Length == 0))
        //        {
        ...
        //            if (this.FieldCategory != string.Empty)
        //            {
        //                int index = list.IndexOf(this.data.Rows[j][this.FieldCategory].ToString());
        ...
        //            if ((this.XAxisLabels != null) && (this.XAxisLabels != string.Empty))
        //            {
        //                SizeF ef = graphics.MeasureString(this.data.Rows[j][this.XAxisLabels].ToString(), this.FieldLabelFont);
        //                graphics.DrawString(this.data.Rows[j][this.XAxisLabels].ToString(), this.FieldLabelFont, brush2, num9 - (ef.Width / 2f), (float) (num10 + 5));
        //            }
        //        }
        //        else
        //        {
        ...
        //            if (this.FieldCategory != string.Empty)
        //            {
        //                int num12 = list.IndexOf(this.data.Rows[j][this.FieldCategory].ToString());
        ...
        //            if ((this.XAxisLabels != null) && (this.XAxisLabels != string.Empty))
        //            {
        //                SizeF ef2 = graphics.MeasureString(this.data.Rows[j][this.XAxisLabels].ToString(), this.FieldLabelFont);
        //                graphics.DrawString(this.data.Rows[j][this.XAxisLabels].ToString(), this.FieldLabelFont, brush2, num9 - (ef2.Width / 2f), (float) ((num10 + 5) + (image2.Height / 2)));
        //            }
        //        }
        //        if ((this.FieldID != null) && (this.FieldID != string.Empty))
        //        {
        //            string str = this.data.Rows[j][this.FieldID].ToString();
        //            ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
        //            if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
        //            {
        //                spot.AlternateText = this.data.Rows[j][this.XAxisLabels].ToString();
        ...
        private Bitmap DrawMulti3DLine()
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                for (int j = 0; j < num4; j++)
                {
                    if (row[this.dataItems[j]] == DBNull.Value)
                    {
                        throw new Exception("ERROR: DataItem '" + this.dataItems[j] + "' not found! Check the DataItems property elements or SetDataFields method to set the corect fileds that will appear on the Y axis.");
                    }
                    if (Convert.ToDecimal(row[this.dataItems[j]]) < lowest)
                    {
                        lowest = Convert.ToDecimal(row[this.dataItems[j]]);
                    }
                    if (Convert.ToDecimal(row[this.dataItems[j]]) > heighest)
                    {
                        heighest = Convert.ToDecimal(row[this.dataItems[j]]);
                    }
                }
            }
            if (lowest > 0M)
            ...
            for (int i = 0; i < num4; i++)
            {
                ...
                for (int k = 0; k < count; k++)
                {
                    ...
                    try
                    {
                        num15 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[k][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                ...
                if (this.ValueLabelsFormatString != string.Empty)
                {
                    for (int m = 0; m < count; m++)
                    {
                        ...
                        try
                        {
                            num19 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                        }
                        catch
                        {
                        }
                        ...
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, (num20 - (size.Width / 2f)) + (((num4 - i) - 1) * num9), ((num21 - size.Height) - (((num4 - i) - 1) * num9)) + 1f, size));
                    }
                    Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, 10);
                }
            }
            return image;
        }
        ...
        private Bitmap DrawMultiBars()
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                for (int k = 0; k < num4; k++)
                {
                    if (row[this.dataItems[k]] == DBNull.Value)
                    {
                        throw new Exception("ERROR: DataItem '" + this.dataItems[k] + "' not found! Check the DataItems property elements or SetDataFields method to set the corect fileds that will appear on the Y axis.");
                    }
                    if (Convert.ToDecimal(row[this.dataItems[k]]) < lowest)
                    {
                        lowest = Convert.ToDecimal(row[this.dataItems[k]]);
                    }
                    if (Convert.ToDecimal(row[this.dataItems[k]]) > heighest)
                    {
                        heighest = Convert.ToDecimal(row[this.dataItems[k]]);
                    }
                }
            }
            if (lowest > 0M)
            ...
            for (int j = 0; j < count; j++)
            {
                for (int m = 0; m < num4; m++)
                {
                    ...
                    try
                    {
                        height = Convert.ToInt32((decimal) ((ScaleBreaks.ValRec(this.data.Rows[j][this.dataItems[m]], this.ScaleBreakMin, this.ScaleBreakMax) / (((heighest - lowest) + this.ScaleBreakMin) - this.ScaleBreakMax)) * (this.graphHeight - this.ScaleBreakHeight)));
                    }
                    catch
                    {
                    }
                    if (height != 0)
                    {
                        ...
                        if (height > 0)
                        {
                            ...
                            g.DrawImage(image, new Rectangle(x, y, width, height), 0, 0, image.Width, image.Height, GraphicsUnit.Pixel, imageAttr);
                            this.xmlChart.AddBar(height, width, (float) x, (float) y, new ColorItem((brushArray[m] as SolidBrush).Color).ToString(), (brushArray[m] as SolidBrush).Color.A, 0, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j })), this.GetToolTip(j));
                        }
                        else
                        {
                            if (this.ShadowIsDrawn)
                            ...
                            g.DrawImage(image, new Rectangle(x, y + height, width, -height), 0, 0, image.Width, image.Height, GraphicsUnit.Pixel, imageAttr);
                            this.xmlChart.AddBar(-height, width, (float) x, (float) (y + height), new ColorItem((brushArray[m] as SolidBrush).Color).ToString(), (brushArray[m] as SolidBrush).Color.A, 0, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j })), this.GetToolTip(j));
                        }
                        ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                        if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                        {
                        ...
                        spot.PostBackValue = string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j });
                        spot.Left = x;
                        spot.Right = x + width;
                        spot.Top = y + this.graphstartsY;
                        spot.Bottom = (y + height) + this.graphstartsY;
            ...
            if (this.ValueLabelsFormatString != string.Empty)
            {
                ...
                for (int n = 0; n < count; n++)
                {
                    for (int num18 = 0; num18 < num4; num18++)
                    {
                        ...
                        try
                        {
                            num19 = Convert.ToInt32((decimal) ((ScaleBreaks.ValRec(this.data.Rows[n][this.dataItems[num18]], this.ScaleBreakMin, this.ScaleBreakMax) / (((heighest - lowest) + this.ScaleBreakMin) - this.ScaleBreakMax)) * (this.graphHeight - this.ScaleBreakHeight)));
                        }
                        catch
                        {
                        }
                        ...
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[n][this.dataItems[num18]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, num20 + ((width - size.Width) / 2f), (num21 - size.Height) + 1f, size));
                    }
                }
                Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, offsetYTop);
            }
            ...
            for (int j = 0; j < count; j++)
            {
                for (int m = 0; m < num4; m++)
                {
                    ...
                    if (height != 0)
                    {
                        ...
                        this.xmlChart.AddBar(height, width, (float) x, (float) y, new ColorItem((brushArray[m] as SolidBrush).Color).ToString(), (brushArray[m] as SolidBrush).Color.A, depth, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j })), this.GetToolTip(j));
                        if (this.ValueLabelsFormatString != string.Empty)
                        {
                            string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]));
                            SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                            list.Add(new Charts.ChartLabel(text, x + (((width - size.Width) + depth) / 2f), ((y - size.Height) + 1f) - (depth / 2), size));
                        }
                        ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                        if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                        {
        ...
        private Bitmap DrawMultiCurve()
        {
            ...
            for (int i = 0; i < num4; i++)
            {
                ...
                for (int k = 0; k < count; k++)
                {
                    ...
                    try
                    {
                        num12 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[k][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                ...
                foreach (Point point2 in points)
                {
                    ...
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[num15][this.dataItems[i]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, point2.X - (size.Width / 2f), ((point2.Y - size.Height) - 5f) + 1f, size));
                    }
                    ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                    if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
                    {
                    ...
                    spot.PostBackValue = string.Concat(new object[] { this.GetID(num15), "|", this.dataItems[i].Name, "|", num15 });
        ...
        {
            KeyItemCollection keyLabels = this.KeyLabels;
            int count = keyLabels.Count;
            int length = 0;
            int num3 = 0;
            for (int i = 0; i < count; i++)
            {
                if (keyLabels[i].Name.Length > length)
                {
                    length = keyLabels[i].Name.Length;
                    num3 = i;
                }
            }
            Bitmap image = new Bitmap(10, 10);
        ...
        private Bitmap DrawMultiLine()
        {
            ...
            for (int i = 0; i < num4; i++)
            {
                ...
                for (int k = 0; k < count; k++)
                {
                    ...
                    try
                    {
                        num14 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[k][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    spot.PostBackValue = string.Concat(new object[] { this.GetID(k), "|", this.dataItems[i].Name, "|", k });
                    spot.Left = num15 - 5;
                    spot.Right = num15 + 5;
                ...
                if (this.ValueLabelsFormatString != string.Empty)
                {
                    for (int m = 0; m < count; m++)
                    {
                        ...
                        try
                        {
                            num18 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                        }
                        catch
                        {
                        }
                        ...
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, num19 - (size.Width / 2f), ((num20 - size.Height) - 5f) + 1f, size));
                    }
                }
                Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, 10);
            }
        ...
        private Bitmap DrawMultiRadar(bool full)
        {
            ...
            //    throw new Exception("ERROR: No Data Fileds set! Use either DataItems property or SetDataFields method to set the fileds that will appear on the Y axis.");
            //}
            int count = this.dataItems.Count;
            ...
            foreach (DataRow row in this.data.Rows)
            {
                for (int j = 0; j < count; j++)
                {
                    ...
                    if (Convert.ToDecimal(row[this.dataItems[j]]) < num2)
                    {
                        num2 = Convert.ToDecimal(row[this.dataItems[j]]);
                    }
                    if (Convert.ToDecimal(row[this.dataItems[j]]) > heighest)
                    {
                        heighest = Convert.ToDecimal(row[this.dataItems[j]]);
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (this.ShadowIsDrawn)
                {
                    for (int m = 0; m < (n + 1); m++)
                    {
                        ...
                        try
                        {
                            num14 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[num13][this.dataItems[i]]) / (heighest - num2)) * r));
                        }
                        catch
                        {
                        }
                ...
                for (int k = 0; k < (n + 1); k++)
                {
                    ...
                    try
                    {
                        num20 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[num19][this.dataItems[i]]) / (heighest - num2)) * r));
                    }
                    catch
                    {
                    }
                    ...
                    if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[num19][this.dataItems[i]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        Charts.ChartLabel item = new Charts.ChartLabel(text, num22 - (size.Width / 2f), num23 - (size.Height / 2f), size);
                        list.Add(item);
                    }
                    num10 = num22;
                    num11 = num23;
            ...
            for (int i = 0; i < num4; i++)
            {
                ...
                if (this.ValueLabelsFormatString != string.Empty)
                {
                    for (int m = 0; m < count; m++)
                    {
                        ...
                        try
                        {
                            num21 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]) / (heighest - lowest)) * this.graphHeight));
                        }
                        catch
                        {
                        }
                        ...
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[i]]));
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, num22 - (size.Width / 2f), (num23 - size.Height) + 1f, size));
                    }
                    Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, 10);
                }
            }
        ...
        private Bitmap DrawMultiSurface3D()
        {
            ...
            for (int j = 0; j < num4; j++)
            {
                ...
                for (int m = 0; m < count; m++)
                {
                    ...
                    try
                    {
                        num19 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[m][this.dataItems[j]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    if (x != -2147483648)
                    {
                        ...
                        if (this.ValueLabelsFormatString != string.Empty)
                        {
                            string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[m][this.dataItems[0]]));
                            SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                            list.Add(new Charts.ChartLabel(text, num20 - (size.Width / 2f), (float) num21, size));
                        }
                    }
                    x = num20;
                    y = num21;
        ...
        private Bitmap DrawRadar(bool full)
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                ...
                if (Convert.ToDecimal(row[this.dataItems[0]]) < num2)
                {
                    num2 = Convert.ToDecimal(row[this.dataItems[0]]);
                }
                if (Convert.ToDecimal(row[this.dataItems[0]]) > heighest)
                {
                    heighest = Convert.ToDecimal(row[this.dataItems[0]]);
            ...
            if (this.ShadowIsDrawn)
            {
                for (int j = 0; j < (count + 1); j++)
                {
                    ...
                    try
                    {
                        num11 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[num10][this.dataItems[0]]) / (heighest - num2)) * r));
                    }
                    catch
                    {
                    }
            ...
            for (int i = 0; i < (count + 1); i++)
            {
                ...
                try
                {
                    num17 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[num16][this.dataItems[0]]) / (heighest - num2)) * r));
                }
                catch
                {
                }
                ...
                if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
                {
                    string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[num16][this.dataItems[0]]));
                    SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                    Charts.ChartLabel item = new Charts.ChartLabel(text, num19 - (size.Width / 2f), num20 - (size.Height / 2f), size);
                    list.Add(item);
                }
                num7 = num19;
                num8 = num20;
        ...
        private Bitmap DrawStackedBars()
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                ...
                for (int k = 0; k < num4; k++)
                {
                    ...
                    num5 += Convert.ToDecimal(row[this.dataItems[k]]);
                }
                if (num5 < lowest)
                {
                    lowest = num5;
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                for (int m = 0; m < num4; m++)
                {
                    ...
                    try
                    {
                        num18 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                ...
                for (int n = 0; n < num4; n++)
                {
                    ...
                    try
                    {
                        num20 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    this.xmlChart.AddBar(num20, width, (float) x, (float) y, new ColorItem((brushArray[n] as SolidBrush).Color).ToString(), (brushArray[n] as SolidBrush).Color.A, 0, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[n].Name, "|", j })), this.GetToolTip(j));
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]));
                        SizeF ef = g.MeasureString(text, this.ValueLabelsFont);
        ...
        private Bitmap DrawStackedBars3D()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                for (int n = 0; n < num4; n++)
                {
                    ...
                    try
                    {
                        height = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    g.DrawImage(image, pointArray4, new Rectangle(0, 0, image.Width, image.Height), GraphicsUnit.Pixel, imageAttr);
                    num16 += height;
                    this.xmlChart.AddBar(height, width, (float) x, (float) y, new ColorItem((brushArray[n] as SolidBrush).Color).ToString(), (brushArray[n] as SolidBrush).Color.A, depth, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[n].Name, "|", j })), this.GetToolTip(j));
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        num20 += Convert.ToDecimal(this.data.Rows[j][this.dataItems[n]]);
                        string text = string.Format(this.ValueLabelsFormatString, num20);
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, x + ((width - size.Width) / 2f), (float) (y + 1), size));
                    }
                    Charts.ChartLabel.DrawList(list, g, this.ValueLabelsFont, Brushes.Black, this.graphWidth, this.graphHeight, offsetX, offsetYTop);
                    ChartRectangleHotSpot spot = new ChartRectangleHotSpot();
                    if ((this.XAxisLabels != string.Empty) && (this.XAxisLabels != null))
        ...
        private Bitmap DrawStackedBars3DFull()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                {
                    num11 += Convert.ToDecimal(this.data.Rows[j][this.dataItems[k]]);
                }
                int num13 = 0;
                ...
                {
                    graphHeight = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / num11) * this.graphHeight));
                    ...
                    g.DrawImage(image, pointArray4, new Rectangle(0, 0, image.Width, image.Height), GraphicsUnit.Pixel, imageAttr);
                    num13 += graphHeight;
                    this.xmlChart.AddBar(graphHeight, width, (float) x, (float) y, new ColorItem((brushArray[m] as SolidBrush).Color).ToString(), (brushArray[m] as SolidBrush).Color.A, depth, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j })), this.GetToolTip(j));
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        num17 = Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / num11;
        ...
        private Bitmap DrawStackedBarsFull()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                for (int k = 0; k < num2; k++)
                {
                    num13 += Convert.ToDecimal(this.data.Rows[j][this.dataItems[k]]);
                }
                int height = 0;
                decimal num16 = 0M;
                for (int m = 0; m < num2; m++)
                {
                    graphHeight = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / num13) * this.graphHeight));
                    y = ((this.graphHeight - graphHeight) - height) + offsetYTop;
                    g.FillRectangle(brushArray[m], x, y, width, graphHeight);
                    this.xmlChart.AddBar(graphHeight, width, (float) x, (float) y, new ColorItem((brushArray[m] as SolidBrush).Color).ToString(), (brushArray[m] as SolidBrush).Color.A, 0, 0, this.GetNavigateUrl(string.Concat(new object[] { this.GetID(j), "|", this.dataItems[m].Name, "|", j })), this.GetToolTip(j));
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        num16 = Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / num13;
        ...
        private Bitmap DrawStackedCylinders()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                for (int m = 0; m < num4; m++)
                {
                    ...
                    try
                    {
                        num19 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
        ...
        private Bitmap DrawStackedRadar(bool full)
        {
            ...
            if (this.ShadowIsDrawn)
            {
                for (int m = 0; m < (n + 1); m++)
                {
                    ...
                    {
                        num14 += Convert.ToDecimal(this.data.Rows[num13][this.dataItems[num15]]);
                    }
                    int num16 = 0;
                    try
                    {
            ...
            for (int j = 0; j < (n + 1); j++)
            {
                ...
                {
                    num23 += Convert.ToDecimal(this.data.Rows[num22][this.dataItems[num25]]);
                    int num26 = 0;
                    try
                    {
                    ...
                    if (numArray[num25] != -2147483648)
                    {
                        ...
                        if ((this.ValueLabelsFormatString != null) && (this.ValueLabelsFormatString != string.Empty))
                        {
                            string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[num22][this.dataItems[num25]]));
                            SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                            Charts.ChartLabel item = new Charts.ChartLabel(text, numArray3[num25] - (size.Width / 2f), numArray4[num25] - (size.Height / 2f), size);
                            list.Add(item);
                        }
                    }
                }
        ...
        private Bitmap DrawStackedSurface()
        {
            ...
            foreach (DataRow row in this.data.Rows)
            {
                ...
                for (int j = 0; j < num4; j++)
                {
                    ...
                    num5 += Convert.ToDecimal(row[this.dataItems[j]]);
                }
                if (num5 < lowest)
                {
                    lowest = num5;
                ...
                for (int k = 0; k < num4; k++)
                {
                    ...
                    if (numArray3[0] != -2147483648)
                    {
                        ...
                        if (this.ValueLabelsFormatString != string.Empty)
                        {
                            ...
                            SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                            list.Add(new Charts.ChartLabel(text, numArray3[k] - (size.Width / 2f), (float) (numArray4[k] + 1), size));
                        }
                        if ((k == (num4 - 1)) && (this.ValueLabelsFormatString != string.Empty))
                        {
                            string str2 = string.Format(this.ValueLabelsFormatString, numArray6[k]);
                            SizeF ef2 = g.MeasureString(str2, this.ValueLabelsFont);
                            list.Add(new Charts.ChartLabel(str2, numArray[k] - (ef2.Width / 2f), (float) (numArray2[k] + 1), ef2));
                        }
                    }
                }
                for (int m = 0; m < num4; m++)
        ...
        private Bitmap DrawStackedSurface3D()
        {
            ...
            for (int j = 0; j < count; j++)
            {
                ...
                for (int m = 0; m < num4; m++)
                {
                    num16 += Convert.ToDecimal(this.data.Rows[j][this.dataItems[m]]);
                    int num18 = 0;
                    try
                    {
                    ...
                    if (this.ValueLabelsFormatString != string.Empty)
                    {
                        string text = string.Format(this.ValueLabelsFormatString, numArray5[m]);
                        SizeF size = g.MeasureString(text, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(text, numArray3[m] - (size.Width / 2f), (float) (numArray4[m] + 1), size));
                    }
                    if ((m == (num4 - 1)) && (this.ValueLabelsFormatString != string.Empty))
                    {
                        string str2 = string.Format(this.ValueLabelsFormatString, numArray6[m]);
                        SizeF ef2 = g.MeasureString(str2, this.ValueLabelsFont);
                        list.Add(new Charts.ChartLabel(str2, numArray[m] - (ef2.Width / 2f), (float) (numArray2[m] + 1), ef2));
                    }
                }
                for (int n = 0; n < num4; n++)
                {
        ...
        private Bitmap DrawSurface()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                try
                {
                    num12 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                }
                catch
                {
                }
            ...
            if (this.ValueLabelsFormatString != string.Empty)
            {
                for (int j = 0; j < count; j++)
                {
                    ...
                    try
                    {
                        num18 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
                    ...
                    int num20 = (this.graphHeight - num18) + offsetYTop;
                    string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[j][this.dataItems[0]]));
                    SizeF ef = g.MeasureString(text, this.ValueLabelsFont);
        ...
        private Bitmap DrawSurface3D()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                try
                {
                    num14 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                }
                catch
                {
                }
            ...
            if (this.ValueLabelsFormatString != string.Empty)
            {
                for (int j = 0; j < count; j++)
                {
                    ...
                    try
                    {
                        num20 = Convert.ToInt32((decimal) ((Convert.ToDecimal(this.data.Rows[j][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
                    }
                    catch
                    {
                    }
        ...
        //        try
        //        {
        //            height = Convert.ToInt32((decimal)((Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]) / (heighest - lowest)) * this.graphHeight));
        //        }
        //        catch
        //        {
        //        }
        ...
        //            }
        //        }
        //        int num13 = Convert.ToInt32((float)((((float)winCustomImage.Width) / ((float)width)) * height));
        //        if (num13 > winCustomImage.Height)
        //        {
        //            num13 = winCustomImage.Height;
        //        }
        //        g.DrawImage(winCustomImage, new Rectangle(x, y, width, height), new Rectangle(0, 0, winCustomImage.Width, num13), GraphicsUnit.Pixel);
        //        if (this.chartDataControl != null)
        //        {
        //            this.xmlChart.AddUserBar(height, width, (float)x, (float)y, "0", 0xff, (this.chartDataControl as McWebChart).CustomImage, 0, this.GetNavigateUrl(this.GetID(i) + "||" + i));
        //        }
        //        if (this.ValueLabelsFormatString != string.Empty)
        //        {
        //            string text = string.Format(this.ValueLabelsFormatString, Convert.ToDecimal(this.data.Rows[i][this.dataItems[0]]));
        ...
        private void DrawXAxis(Graphics g, int offsetX, float barWidth, int depth, int graphHeight, int offsetTop, int Spacer, bool fixLabel)
        {
                ...
                if (this.DrawGrid)
                {
                    ...
                    for (num2 = 0; num2 < (this.data.Rows.Count + 5); num2++)
                    {
                        if ((num2 % num8) == 0)
                        {
                            ...
                            {
                                g.DrawLine(penGrid, num9, 0, num9, (graphHeight + offsetTop) - depth);
                                this.xmlChart.AddLine(num9, 0, num9, (graphHeight + offsetTop) - depth, 1, "0", 0xff);
                                g.DrawLine(penGrid, num9, (graphHeight + offsetTop) - depth, num9 - depth, graphHeight + offsetTop);
            ...
            if (this.ShowRecursionEquations)
            {
                ...
                {
                    if (((item.hint != null) && !(item.hint == "")) && ((item.Name != null) && !(item.Name == "")))
                    {
                        string str5 = item.Name + item.hint;
        ...
        private void DrawYAxis(Graphics g, decimal lowest, decimal heighest, int offsetYTop, int offsetYBottom, int offsetX, int depth)
        {
            ...
            g.DrawLine(penGrid, (num4 + 5) + depth, -depth, (num4 + 5) + depth, (this.graphHeight + offsetYTop) - depth);
            ...
            while (num3 < (heighest + (2 * num2)))
            {
                ...
                else
                {
                    ...
                    if (this.DrawGrid || (num3 == 0M))
                    {
                        ...
                        g.DrawLine(penGrid, (int)(num4 + 5), (int)((num12 - 1) - this.negativeOffset), (int)((num4 + 5) + depth), (int)(((num12 - 1) - depth) - this.negativeOffset));
                        this.xmlChart.AddLine(num4 + 5, (num12 - 1) - this.negativeOffset, (num4 + 5) + depth, ((num12 - 1) - depth) - this.negativeOffset, 1, "0", 0xff);
                        g.DrawLine(penGrid, (int)((num4 + 5) + depth), (int)(((num12 - 1) - depth) - this.negativeOffset), (int)(this.graphWidth + offsetX), (int)(((num12 - 1) - depth) - this.negativeOffset));
        ...
        private string GetID(int i)
        {
            if ((this.FieldID != null) && !(this.FieldID == string.Empty))
            {
                return this.data.Rows[i][this.FieldID].ToString();
            }
            return string.Empty;
        }
        ...
        private string GetNavigateUrl(string data)
        {
            ...
            return (this.chartDataControl as McGraph).GetNavigateUrl(data);
        }
        ...
        {
            return new Bitmap(Assembly.GetExecutingAssembly().GetManifestResourceStream("Nistec.Charts.Resources." + file));
        }
