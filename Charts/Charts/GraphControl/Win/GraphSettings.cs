namespace Nistec.Charts.Win
{
    ...
    internal class GraphSettings : Form
    {
        ...
        private WinChartDesigner designer;
        ...
        internal GraphSettings(McGraph chart, WinChartDesigner designer)
        {
        ...
        private void InitializeComponent()
        {
            ...
            System.Windows.Forms.TreeNode treeNode1 = new System.Windows.Forms.TreeNode("Available Fileds:");
            ...
            treeNode1.Text = "Available Fileds:";
            ...
            this.randomToolStripMenuItem.Click += new System.EventHandler(this.randomDataToolStripMenuItem_Click);
            // 
            // lbDataFields
            // 
        ...
        {
            int[] numArray = new int[] { 0, 2, 12, 3, 30, 0x1d, 0x11, 5, 0x10, 1, 13, 0x12, 0x13, 14, 20 };
            for (int j = 0; j < numArray.Length; j++)
            {
                if (numArray[j] == i)
                {
        ...
        private void Populate()
        {
            ...
            try
            {
                manager = (CurrencyManager)base.BindingContext[this.chart.DataSource, this.chart.DataMember];
            }
            catch (ArgumentException)
            {
                return;
            }
            foreach (PropertyDescriptor descriptor in manager.GetItemProperties())
            {
                this.cbIDField.Items.Add(descriptor.Name);
                this.cbLabels.Items.Add(descriptor.Name);
                try
                {
                    this.tvAvailable.Nodes[0].Nodes.Add(descriptor.Name, descriptor.Name);
                    continue;
                }
                catch
                {
        ...
        internal void saveItems()
        {
            ...
            if (descriptor != null)
            {
                descriptor.SetValue(this.chart, (Nistec.Charts.ChartType)this.cbType.SelectedIndex);
            }
            ...
            {
                this.chart.ColorItems = this.col;//.ColorItems;
            }
        }
        ...
        private new void Validate()
        {
            try
            {
                ...
                else
                {
                    ...
                    //}
                    //else if ((this.cbType.SelectedIndex == 0x10) && (this.chart.CustomImage == null))
                    //{
                    //    this.SetError("For the Map Mode you should set the CustomImage property.");
                    //}
                    //else if ((this.cbType.SelectedIndex == 20) && (this.chart.CustomImage == null))
                    //{
