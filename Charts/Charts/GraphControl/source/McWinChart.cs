namespace MControl.Charts.Win
{
    ...
    [ToolboxBitmap(typeof(McWinChart), "MControl.Charts.Resources.graph.bmp")]
    [DefaultProperty("GraphTitle"), Designer(typeof(WinChartDesigner))]
    public class McWinChart : UserControl, ISupportInitialize
    {
                ...
                try
                {
                    ...
                    if (base.DesignMode)
                    {
                        if (this.Chart.x.Count == 0)
                        {
                            ...
                            this.DataSeries = this.DataSeries;
                        }
        ...
        public DataRowView GetDataRow(Point p)
        {
            ...
            {
                foreach (HotSpot spot in (HotSpotCollection) this.Chart.colectieHotspoturi)
                {
                    if (!(spot is RectangleHotSpot))
                    {
                        continue;
                    }
                    RectangleHotSpot spot2 = (RectangleHotSpot) spot;
                    ...
                    if (((spot2.Bottom >= e.Y) && (spot2.Top <= e.Y)) && ((spot2.Left <= e.X) && (spot2.Right >= e.X)))
                    {
                        try
                        {
                            ...
                            if (this.ChartClick.GetInvocationList().Length > 0)
                            {
                                ...
                                {
                                    this.ChartClick(this, strArray[0], this.Chart.x[0].str, position);
                                }
                            }
                        }
                        catch
        ...
        [Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Bindable(true), Category("Chart"), Description("The names of the columns used as data series (this will be y values)."), NotifyParentProperty(true)]
        ...
        [Bindable(true), Category("Chart"), DefaultValue((double) 0.2), Description("Used only with Exploded3DPie and Exploded3Ddonut modes. The valid range is (0-1). It controls how far apart are the slices."), Browsable(true)]
        ...
        [Localizable(true), Editor("System.Windows.Forms.Design.DataMemberFieldEditor, System.Design", typeof(UITypeEditor)), Bindable(true), Browsable(true), Category("Chart"), Description("The CategoryID Column of the table. Used for MapPoints and Map chart-types only. Based on the category the points/regions are color coded.")]
        public string IDCategory
        {
            get
            {
                return this.chart.IDCategory;
            }
            set
            {
                this.chart.IDCategory = value;
            }
        }

        [Editor("System.Windows.Forms.Design.DataMemberFieldEditor, System.Design", typeof(UITypeEditor)), Browsable(true), Bindable(true), Localizable(true), Category("Chart"), Description("The IDColumn Name of the table. Used for Map mode.")]
        public string IDField
        {
            get
            {
                return this.Chart.IDField;
            }
            set
            {
                this.Chart.IDField = value;
                this.draw();
            }
        }
        ...
        [Bindable(true), Category("Chart"), DefaultValue("labels"), Description("This column is used for the small labels under the x axis, or for generating the key in 'pie-graphs'"), Editor("System.Windows.Forms.Design.DataMemberFieldEditor, System.Design", typeof(UITypeEditor)), NotifyParentProperty(true), Browsable(true)]
        ...
        //[Category("Chart"), Bindable(true), Browsable(true), Description("List of values from which the key will be generated. This is only valid for graph types that show more than one series. Theese strings should be the 'user-friendly' names of the columns set with 'DataSeries'."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), Localizable(true)]
        ...
        [Category("Chart"), Description("The xml text that contains the map data. Used for Map modes."), Editor(typeof(MyXmlEditor), typeof(UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), NotifyParentProperty(true), Bindable(true), Localizable(true), Browsable(true)]
        ...
        [Category("Chart"), NotifyParentProperty(true), Bindable(true), Browsable(true), Description("The Images used as points for MapPoints Chart Type."), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [Category("Chart"), DefaultValue(15), Description("This is the offest of the shadow. For most graphs both X and Y should be positive. For some types theese values are ignored."), Browsable(true), Bindable(true)]
        ...
        [Category("Chart"), Bindable(true), DefaultValue(0), Browsable(true), Description("The Graph Type(Bars, Pie, StackedBars, etc).")]
        ...
        [Category("Chart"), Localizable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), NotifyParentProperty(true), Description("User Image. Used for userDrawnBars mode and Maps."), Browsable(true), Bindable(true)]
        public System.Drawing.Image UserImage
        {
            get
            {
                return (System.Drawing.Image) this.Chart.WinUserImage;
            }
            set
            {
                this.Chart.WinUserImage = value;
                this.draw();
            }
        }
        ...
        [Browsable(true), NotifyParentProperty(true), Bindable(true), Category("Chart"), DefaultValue("X Axis Label"), Description("X axis name. This will apear as a label below the x axis."), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        ...
        [DefaultValue("Y Axis Label"), Category("Chart"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), NotifyParentProperty(true), Description("Y axis name. This will apear as a label before the y axis."), Browsable(true), Bindable(true)]
