...
namespace Nistec.Wizards.Design
{
    ...
    internal class McTabListDesigner : ParentWizDesignerBase
    {
		...
		private Nistec.Wizards.McTabList ctl;
		...
		public override void Initialize(IComponent component)
		{
			...
			this.ctl = component as Nistec.Wizards.McTabList;
		}
		...
		public override ICollection AssociatedComponents
		{
			get 
			{
				//                if (base.Control is Nistec.Wizards.McTabList)
				//                    return ((Nistec.Wizards.McTabList)base.Control).TabPages;
				//                else
		...
		protected override void WndProc(ref Message msg)
		{
			...
			{
				Nistec.Wizards.McTabList wizardControl = this.SelectionService.PrimarySelection as Nistec.Wizards.McTabList;
		...
		private void OnMoveNext(object sender, EventArgs e)
		{
			...
			if (num1 < (this.ctl.TabPages.Count - 1))
			{
		...
		{
			McTabList wizControl = (McTabList) base.Component;
		...
		{
			McTabList wizControl = (McTabList) base.Component;
			if ((wizControl != null) && (wizControl.TabPages.Count != 0))
			{
				MemberDescriptor descriptor1 = TypeDescriptor.GetProperties(base.Component)["Controls"];
				...
				if (host1 != null)
				{
					...
					try
					{
						...
						wizControl.TabPages.Remove(page1); 
