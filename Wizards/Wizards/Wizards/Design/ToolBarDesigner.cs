...
namespace mControl.WinCtl.Controls.Design
{
	internal class ToolBarDesigner : ParentControlDesigner
	{
		...
		public override void Initialize(IComponent component)
		{
			...
			this.toolBar = (CtlToolBar) base.Control;
		}
		...
		private void OnAddSeparator(object sender, EventArgs e)
		{
			...
			CtlToolButton button1 = (CtlToolButton) host1.CreateComponent(typeof(CtlToolButton));
			button1.Dock = DockStyle.Left;
			button1.ButtonStyle = ToolBarButtonStyle.Separator;
			button1.Width = 8;
        ...
        private void OnAddToolDropDown(object sender, EventArgs e)
        {
            ...
            CtlToolButton button1 = (CtlToolButton)host1.CreateComponent(typeof(CtlToolButton));
            button1.Dock = DockStyle.Left;
            button1.ButtonStyle = ToolBarButtonStyle.DropDownButton;
            button1.Width = 33;
            button1.ParentBar = this.toolBar;
            this.toolBar.Controls.Add(button1);
            this.toolBar.Controls.SetChildIndex(button1, 0);
		...
		public override DesignerVerbCollection Verbs
		{
			get
			{
				//return new DesignerVerbCollection(new DesignerVerb[] { this.addToolButton, this.addSeparator,this.addPainter });
	...
	internal class ToolButtonDesigner : ParentControlDesigner
	{
		...
		{
			base.Initialize(component);
			this.toolButton = component as ICtlToolButton;
		}
		...
		private ICtlToolButton toolButton;
	}
