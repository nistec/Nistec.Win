...
namespace MControl.WinUI
{
    ...
    /// </summary>
    [ToolboxItem(true), ToolboxBitmap(typeof(McTabPanels), "Toolbox.TabList.bmp")]
    [Designer(typeof(Design.McTabListDesigner))]
    public class McTabList : McUserControl
    {
        ...
        protected MControl.WinForms.McLabel _lbl;
        protected MControl.WinForms.McTabControl _tabControl;
        private MControl.WinForms.McPanel panelBase;
        private MControl.WinForms.McPanel panelTabs;
        internal MControl.WinForms.McSplitter splitter1;
        private MControl.WinForms.McPanel panelList;
        private MControl.WinForms.McListBox listBox1;
        ...
        private void InitializeComponent()
        {
            ...
            this._tabControl = new MControl.WinForms.McTabControl();
            this.panelBase = new MControl.WinForms.McPanel();
            this.panelTabs = new MControl.WinForms.McPanel();
            this.splitter1 = new MControl.WinForms.McSplitter();
            this.panelList = new MControl.WinForms.McPanel();
            this.listBox1 = new MControl.WinForms.McListBox();
            this._lbl = new MControl.WinForms.McLabel();
            ...
            this._tabControl.HideTabs=true;//.TabPosition = MControl.WinForms.TabPosition.Hide;
