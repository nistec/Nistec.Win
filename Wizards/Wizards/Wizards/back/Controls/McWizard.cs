...
namespace MControl.Wizards
{
	...
	[ToolboxItem(true),	ToolboxBitmap(typeof(McWizardControl),"Toolbox.WizControl.bmp")]
    [DefaultProperty("WizardType")]
    [Designer(typeof(Design.McWizardControlDesigner))]
    public class McWizardControl : MControl.WinForms.Controls.McContainer, IWizControl// System.Windows.Forms.UserControl,IStyleCtl
	{
        ...
        public System.Collections.Generic.List<int> PagesFlow
        {
            get 
            {
                if (_PagesFlow == null)
...
//				m_netFram=MControl.Util.Net.nf_1.nf_2(method,pk);
//			}
//			catch{}
//		}
...
//        protected McStatus _showHelp, _enableHelp;
        ...
        protected MControl.WinForms.McButton _buttonBack;
        protected MControl.WinForms.McButton _buttonNext;
        protected MControl.WinForms.McButton _buttonFinish;
        protected MControl.WinForms.McButton _buttonClose;
        protected MControl.WinForms.McButton _buttonHelp;
        protected MControl.WinForms.McTabControl _tabControl;
		//private MControl.WinForms.Styles _StylePlan;
        ...
        public delegate void WizardPageHandler(WizardPage wp, McWizardControl wc);
        ...
        static McWizardControl()
        {
            // Create a strip of images by loading an embedded bitmap resource
            _standardPicture = DrawUtils.LoadBitmap(Type.GetType("MControl.Wizards.McWizardControl"),
                                                        "MControl.Wizards.Images.mCtlIcon32.bmp");
  
		}

        public McWizardControl()
		{
            _totalPages = -1;
...
//            _showHelp = _enableHelp = McStatus.Default;
		...
		{
            this._tabControl = new MControl.WinForms.McTabControl(this);
			...
			this._buttonBack = new MControl.WinForms.McButton();
			this._buttonNext = new MControl.WinForms.McButton();
			this._buttonCancel = new MControl.WinForms.McButton();
			this._buttonFinish = new MControl.WinForms.McButton();
...
//				| System.Windows.Forms.AnchorStyles.Right)));
			...
			//this._tabControl.StyleCtl.StylePlan = MControl.WinForms.Styles.Custom;
			...
			this._buttonBack.ControlLayout = MControl.WinForms.ControlLayout.XpLayout;
			...
			this._buttonNext.ControlLayout = MControl.WinForms.ControlLayout.XpLayout;
			...
			this._buttonFinish.ControlLayout = MControl.WinForms.ControlLayout.XpLayout;
        ...
        public McTabControl McTabControl
        {
        ...
        internal MControl.WinForms.McPanel ButtonsPanel
        {
        ...
        [DefaultValue(typeof(WizardTypes), "Configure")]
        public WizardTypes WizardType
        {
            ...
            set 
            {
                if (wizardType != value)
                {
                    ...
                    switch(wizardType)
                    {
                        case WizardTypes.Install:
						case WizardTypes.Configure:
                            ...
                            if (_tabControl.SelectedIndex != -1)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (wizardType != WizardTypes.Controller)
                                        LeaveFullPage();
                                }
                            }
                            else
        ...
        {
            WizardType = WizardTypes.Configure;
        }
