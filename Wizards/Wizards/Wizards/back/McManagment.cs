...
namespace MControl.Wizards
{
	...
	public class McManagment : MControl.WinForms.Controls.McContainer
	{
        ...
        protected MControl.WinForms.McCaption topCaption;
		...
		private void InitializeComponent()
		{
            ...
            this.topCaption = new MControl.WinForms.McCaption();
            this.styleGuide = new MControl.WinForms.StyleGuide(this.components);
            this.toolBar = new MControl.WinForms.McToolBar();
            this.tbHelp = new MControl.WinForms.McToolButton();
            this.tbOption = new MControl.WinForms.McToolButton();
            this.tbOK = new MControl.WinForms.McToolButton();
            this.tbClose = new MControl.WinForms.McToolButton();
            this.statusBar = new MControl.WinForms.McStatusBar();
            this.panelBase = new MControl.WinForms.McPanel();
            this.panelTabs = new MControl.WinForms.McPanel();
            this.tabPages = new MControl.WinForms.McTabControl();
            this.splitter = new MControl.WinForms.McSplitter();
            this.panelList = new MControl.WinForms.McPanel();
            this.treeView = new MControl.WinForms.McTreeView();
            this.lblList = new MControl.WinForms.McLabel();
            ...
            this.topCaption.Text = "MControl Explorer Wizard";
            // 
            // styleGuide
            // 
            ...
            this.styleGuide.FlatColor = System.Drawing.Color.FromArgb(((int)(((byte)(247)))), ((int)(((byte)(245)))), ((int)(((byte)(232)))));
            ...
            this.styleGuide.StylePlan = MControl.WinForms.Styles.Desktop;
            ...
            this.toolBar.ControlLayout = MControl.WinForms.ControlLayout.Visual;
            ...
            this.toolBar.ButtonClick += new MControl.WinForms.ToolButtonClickEventHandler(this.toolBar_ButtonClick);
            // 
            // tbHelp
            // 
            ...
            // tbOption
            // 
            this.tbOption.ButtonStyle = MControl.WinForms.ToolButtonStyle.DropDownButton;
            ...
            // tbOK
            // 
            this.tbOK.ButtonStyle = MControl.WinForms.ToolButtonStyle.Button;
        ...
        [Category("Wizard"),Editor("MControl.WinForms.ToolBarCollectionEditor", typeof(System.Drawing.Design.UITypeEditor)), DesignerSerializationVisibility( DesignerSerializationVisibility.Content)]
        public ControlCollection ToolBarItems
        {
            get { return this.toolBar.Controls; }
        }
        ...
        internal MControl.WinForms.McCaption HeaderPanel
		{
		...
		public MControl.WinForms.McStatusBar StatusBar
		{
		...
		protected void OnTabSelectionChanged(EventArgs e)
		{
			...
			if (tabPages.SelectedIndex != -1)
			{
				...
				McTabPage wp = WizardPages[tabPages.SelectedIndex];
