...
namespace PCM.ScriptEngine
{
	...
	public class AppInfo
	{
		...
		public const string PCMClass="PCM_script";
		...
		static AppInfo()
		{
			...
			AppInfo.ScriptLib=GetAppScriptPath()+"\\";//"ScriptLibrary\\App\\";
			AppInfo.DllLib=GetAppScriptPath()+"\\";//"ScriptLibrary\\Dll\\";
		}
		...
		{
			return ScriptLib + "\\" + name + ".csc";
		}

		public static string GetDllFile(string name)
		{
			return DllLib + "\\" + name + ".dll";
		}
