...
//							}
		...
		private string Compile(string scriptFileName) 
		{
			...
			if (parser.apartmentState != System.Threading.ApartmentState.Unknown)
				System.Threading.Thread.CurrentThread.SetApartmentState( parser.apartmentState);
            ...
            //compileParams.ReferencedAssemblies.Add(Config.GetDataAccessReference());
            ...
            CompilerResults results = compiler.CompileAssemblyFromFile(compileParams, parser.FilesToCompile);
