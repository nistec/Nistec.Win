...
namespace Nistec.GridView.Design
{
	...
	internal class GridTableStyleMappingNameEditor : UITypeEditor
	{
		// Methods
		public GridTableStyleMappingNameEditor()
		{
		}
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
		{
			if (provider != null)
			{
				...
				{
					this.designBindingPicker = new DesignBindPicker(context, false, true);
				}
				object obj2 = context.Instance;
				GridTableStyle style1 = (GridTableStyle) context.Instance;
				if (style1.dataGrid == null)
				{
					return value;
				}
				PropertyDescriptor descriptor1 = TypeDescriptor.GetProperties(style1.dataGrid)["DataSource"];
				if (descriptor1 == null)
				{
					return value;
				}
				object obj1 = descriptor1.GetValue(style1.dataGrid);
				if (obj1 != null)
				{
					this.designBindingPicker.Start(context, service1, obj1, new DesignBinding(obj1, (string) value));
