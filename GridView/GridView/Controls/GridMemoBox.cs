...
namespace Nistec.GridView
{
    ...
    public class GridMemoBox : Nistec.WinForms.McMemo
    {
        ...
        #region Methods
        /// <summary>
        /// Initilaized GridMemoBox
        /// </summary>
        internal GridMemoBox()
        {
           ...
           // base.NetReflectedFram("ba7fa38f0b671cbc");
            ...
            //base.defaultControlLayout =Nistec.WinForms.ControlLayout.Flat;    
        }
        /// <summary>
        /// Get Mc Style Layout
        /// </summary>
        ...
        /// <summary>
        /// On RightToLeft property Changed
        /// </summary>
        /// <param name="e"></param>
        ...
        /// </summary>
        /// <param name="e"></param>
        protected override void OnMemoChanged(EventArgs e)
        {
            base.OnMemoChanged(e);
            if (!IsHandleCreated )
                return;
            if (!base.ReadOnly)
            {
        ...
        internal void SelectedTextInternal(string value)
        {
            base.Text=value;
            base.Invalidate();
        }
