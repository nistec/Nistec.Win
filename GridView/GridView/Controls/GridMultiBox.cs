...
{
    /// <summary>
    /// GridMultiBox control 
    /// </summary>
    [DefaultProperty("GridEditName"), DesignTimeVisible(false), ToolboxItem(false)]
    public class GridMultiBox : Nistec.WinForms.McMultiBox
    {
        ...
        #region Methods
        /// <summary>
        /// Initilaizing GridMultiBox control
        /// </summary>
        public GridMultiBox()
        {
        ...
        /// <summary>
        /// Occurs when RightToLeft Changed
        /// </summary>
        /// <param name="e"></param>
        ...
        #region Properties
        /// <summary>
        /// Get or Set indicating whther the control is read only
        /// </summary>
