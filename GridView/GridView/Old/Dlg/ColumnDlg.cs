...
namespace mControl.GridStyle 
{
	...
	public class ColumnDlg : mControl.WinCtl.Forms.FormBase 
	{
		...
		public static void Open(ColumnTypes type,string mappName,string headerText,int width) 
		{
			ColumnDlg f = new ColumnDlg();
		...
		private void SetColumnTypes(ColumnTypes value)
		{
			//string val="None";
			int selIndex=0;
				switch(value)   
				{
					case ColumnTypes.TextColumn:
						selIndex=0;// "TextColumn";
						break;
					case ColumnTypes.ComboColumn:
						selIndex=0;// "ComboColumn";
						break;
					case ColumnTypes.DateTimeColumn:
						selIndex=0;// "DateTimeColumn" ;
						break;
					case ColumnTypes.LabelColumn:
						selIndex=0;// "LabelColumn" ;
						break;
					case ColumnTypes.LinkColumn:
						selIndex=0;// "LinkColumn"  ;
						break;
					case ColumnTypes.ButtonColumn:
						selIndex=0;// "ButtonColumn" ;
						break;
					case ColumnTypes.ProgressColumn:
						selIndex=0;// "ProgressColumn" ;
						break;
					case ColumnTypes.BoolColumn:
						selIndex=0;// "BoolColumn"  ;
						break;
					case ColumnTypes.IconColumn:
						selIndex=0;// "IconColumn"  ;
						break;
					case ColumnTypes.MultiColumn:
		...
		public ColumnTypes ColumnStyle
		{
			get
			{
				...
				switch(this.comboBox1.SelectedItem.ToString ())   
				{
					...
					case "ComboColumn":
						return ColumnTypes.ComboColumn;
					case "DateTimeColumn":
						return ColumnTypes.DateTimeColumn ;
					case "LabelColumn":
						return ColumnTypes.LabelColumn ;
					case "LinkColumn":
						return  ColumnTypes.LinkColumn ;
					case "ButtonColumn":
						return  ColumnTypes.ButtonColumn;
					case "ProgressColumn":
						return  ColumnTypes.ProgressColumn;
					case "BoolColumn":
						return  ColumnTypes.BoolColumn ;
					case "IconColumn":
						return  ColumnTypes.IconColumn ;
					case "MultiColumn":
						return  ColumnTypes.MultiColumn ;
					case "EnumColumn":
						return  ColumnTypes.EnumColumn ;
					case "MenuColumn":
						return  ColumnTypes.MenuColumn;
					case "GridColumn":
						return  ColumnTypes.GridColumn ;
					default:
