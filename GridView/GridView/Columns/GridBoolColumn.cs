...
namespace Nistec.GridView
{
    ...
    public class GridBoolColumn : GridColumnStyle
    {
       ...
       /// <param name="prop"></param>
        ...
        public GridBoolColumn(PropertyDescriptor prop, string format)
        ...
        /// <param name="format"></param>
        /// <param name="isDefault"></param>
        public GridBoolColumn(PropertyDescriptor prop, string format, bool isDefault)
            : base(prop, isDefault)
        {
            //this.xMargin = 2;
            //this.yMargin = 1;
            ...
            //this.Format = format;
            base.m_DataType= FieldType.Bool;
        ...
        private string GetText(object value)
        {
            ...
            return Types.ToBool(value,false).ToString();
        }
        ...
        public override string Text
        {
            ...
            set
            {
                string val= Types.StringToBool(value, false).ToString();
                if (this.edit.IsInEditOrNavigateMode)
                {
                    SetCurrentText(val);
                }
