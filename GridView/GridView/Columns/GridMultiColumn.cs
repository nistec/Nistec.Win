...
{
    /// <summary>
    /// Hosts a MultiBox control in a cell of a GridColumnStyle for editing strings and other options of MultiBox control
    /// </summary>
    public class GridMultiColumn : GridColumnStyle
    {
        ...
        //private int xMargin;
        //private int yMargin;
        internal GridEnumColumn enumCol;
        private VGrid vgrid;
        ...
        #region Ctor
        /// <summary>
        /// Initilaized GridMultiColumn
        /// </summary>
        public GridMultiColumn()
        ...
        public GridMultiColumn(PropertyDescriptor prop)
        ...
        public GridMultiColumn(PropertyDescriptor prop, bool isDefault)
        ...
        public GridMultiColumn(PropertyDescriptor prop, string format)
        ...
        /// <param name="format"></param>
        /// <param name="isDefault"></param>
        public GridMultiColumn(PropertyDescriptor prop, string format, bool isDefault)
            : base(prop, isDefault)
        {
            //this.xMargin = 2;
            //this.yMargin = 1;
            ...
            base.m_ColumnType = GridColumnType.MultiColumn;
        ...
        internal void SetVgrid(VGrid vg)
        {
            vgrid = vg;
        }
        ...
        protected internal override bool Commit(BindManager dataSource, int rowNum)
        {
            ...
            if (!this.edit.IsInEditOrNavigateMode)
            {
                try
                {
                    ...
                    if ((obj1 == null || obj1.ToString() == "") && !AllowTypeNull())
                    {
                        Abort(rowNum);
                        return false;
                    }
        ...
        protected internal override void Edit(BindManager source, int rowNum, Rectangle bounds, bool readOnly, string instantText, bool cellIsVisible)
        {
            ...
            if (vgrid != null)
            {
                 GridField vg = vgrid.GetCurrentField();

                if (vg != null)
                {
                    enabled = vg.Enabled;
                    this.MultiType = vg.MultiType;
                    this.edit.ButtonToolTip = vg.ToolTip;
                    this.edit.Filter = vg.Filter;
                    this.edit.ReadOnly = vg.ReadOnly;
                    if (this.MultiType == MultiType.Combo)
                    {
                        this.edit.Items = vg.Items;
                    }
                }
            } 
            else if (enumCol != null)
            {
                this.edit.MultiType = enumCol.CurrentType();
            }
            if (cellIsVisible && enabled)
            {
                ...
                this.edit.AppendInternalText(GetDisplyValue(val));
       ...
       /// <summary>
        ...
        /// </summary>
        [Browsable(false)]
        public virtual GridMultiBox EditBox
        {
            get
            {
                return this.edit;
        ...
        /// <summary>
        /// Get or Set Display Member of data source
        /// </summary>
        ...
        /// <summary>
        /// Get or Set Value Member of data source
        /// </summary>
        ...
        /// <summary>
        /// Get or Set Multi Combo Types
        /// </summary>
        [DefaultValue(MultiType.Text)]
        ...
        private string GetDisplyValue(object colValue)
        {
            try
            {
                ...
                {
                    return m_LookupView.Values.GetKey(colValue);
                }
                else
                {
                    object s = edit.GetItemText(colValue);
                    if (s == null)
                        s = this.NullText;
                    return s.ToString();
                }
        ...
        private object GetValue()
        {
            try
            {
                if (edit.MultiType == MultiType.Combo)
                {
        ...
        private void SetValue(object colValue)
        {
            try
            {
                ...
                if (this.edit.MultiType == MultiType.Combo)
                {
                    if (edit.DataSource != null)
                    {
        ...
        //[Browsable(false), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        //public Nistec.Data.LookupView LookupView
        //{
        //    get
        //    {
        //        return m_LookupView;
