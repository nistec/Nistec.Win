...
{
    /// <summary>
    /// Hosts a Grid control in a cell of a GridColumnStyle for editing relation grid
    /// </summary>
	public class GridControlColumn : GridColumnStyle
	{
		...
		{
			GridControlColumn.collapsed =NativeMethods.LoadImage("Nistec.GridView.Images.collapsed.gif");
			GridControlColumn.expaned  =NativeMethods.LoadImage ("Nistec.GridView.Images.expaned.gif");

		}
        /// <summary>
        /// Initilaizing Grid Control Column
        /// </summary>
		public GridControlColumn() : this((PropertyDescriptor) null, (string) null)
		{
		}
		...
		public GridControlColumn(PropertyDescriptor prop) : this(prop, null, false)
		{
		}
        /// <summary>
        /// nitilaizing Grid Control Column
		...
		public GridControlColumn(PropertyDescriptor prop, bool isDefault) : this(prop, null, isDefault)
		{
		}
        /// <summary>
        /// nitilaizing Grid Control Column
		...
		public GridControlColumn(PropertyDescriptor prop, string format) : this(prop, format, false)
		{
		}
        /// <summary>
        /// nitilaizing Grid Control Column
        ...
        /// <param name="format"></param>
        /// <param name="isDefault"></param>
		public GridControlColumn(PropertyDescriptor prop, string format, bool isDefault) : base(prop, isDefault)
		{
            //this.xMargin = 2;
            //this.yMargin = 1;
...
//				using(Brush sb1=GridTableStyle.dataGrid.LayoutManager.GetBrushBack())// new SolidBrush (m_BackColor))
//				{
//					//g.FillRectangle(sb1,controlBounds );
//				}
//				using(Pen p=GridTableStyle.dataGrid.LayoutManager.GetPenBorder())// new Pen (m_BorderColor))
//				{
