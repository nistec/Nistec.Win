...
{
    /// <summary>
    /// Hosts a SpinEdit control in a cell of a GridColumnStyle for editing numbers 
    /// </summary>
    public class GridNumericColumn : GridColumnStyle
    {

        #region Fields

        private GridSpinEdit edit;
        ...
        public GridNumericColumn(PropertyDescriptor prop)
        ...
        public GridNumericColumn(PropertyDescriptor prop, bool isDefault)
        ...
        public GridNumericColumn(PropertyDescriptor prop, string format)
        ...
        /// <param name="format"></param>
        /// <param name="isDefault"></param>
        public GridNumericColumn(PropertyDescriptor prop, string format, bool isDefault)
            : base(prop, isDefault)
        {
            //this.xMargin = 2;
            //this.yMargin = 1;
            ...
            base.m_ColumnType = GridColumnType.NumericColumn;
        ...
        protected internal override void Edit(BindManager source, int rowNum, Rectangle bounds, bool readOnly, string instantText, bool cellIsVisible)
        {
            ...
            this.edit.AppendFormatText(this.GetText(this.GetColumnValueAtRow(source, rowNum)));
            ...
            if (!this.edit.ReadOnly && (instantText != null))
            {
                ...
                this.edit.AppendFormatText(this.GetText(instantText));
       ...
       /// <summary>
        ...
        /// <summary>
        /// Set the column propert descriptor
        /// </summary>
        ...
        /// </summary>
        [Browsable(false)]
        public virtual GridSpinEdit EditBox
        {
            get
            {
                return this.edit;
        ...
        /// <summary>
        /// Get or Set the aggriagtion mode
        /// </summary>
        ...
        //        {
        //            if (!Nistec.Win.Info.IsNumber(value))
        //            {
        //                return;
        //            }
        ...
        #region SpinEdit properties
        /// <summary>
        /// Get or set Increment value
        /// </summary>
        [Category("Behavior"), DefaultValue(typeof(decimal), "1")]
        public decimal Increment
        {
            get { return edit.Increment; }

            set
            {
                if (value > 0)
                {
                    this.edit.Increment = value;
                }
            }
        }
        ...
        {
            get { return edit.DecimalPlaces; }
            set
            {
                edit.DecimalPlaces = value;
                Invalidate();
            }
        }
        /// <summary>
        ...
        {
            get { return edit.TextAlign; }
            set { edit.TextAlign = value; }
        }
        /// <summary>
        /// Get or set indicating the Button is Visible
        /// </summary>
        ...
        {
            return Types.ToDecimal(Text,0);// this.GridTableStyle.Grid[this.MappingName], 0);
        }
