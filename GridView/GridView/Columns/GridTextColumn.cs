...
{
    /// <summary>
    /// Hosts a TextBox control in a cell of a GridColumnStyle for editing strings
    /// </summary>
    public class GridTextColumn : GridColumnStyle
    {
       ...
       /// <param name="prop"></param>
        public GridTextColumn(PropertyDescriptor prop)
        ...
        public GridTextColumn(PropertyDescriptor prop, bool isDefault)
        ...
        public GridTextColumn(PropertyDescriptor prop, string format)
        ...
        /// <param name="format"></param>
        /// <param name="isDefault"></param>
        public GridTextColumn(PropertyDescriptor prop, string format, bool isDefault)
            : base(prop, isDefault)
        {
            //this.xMargin = 2;
            //this.yMargin = 1;
            ...
            base.m_ColumnType = GridColumnType.TextColumn;
        ...
        public Formats FormatType
        {
            ...
            set
            {
                if (m_FormatType != value)
                {
                    ...
                    {
                        case Formats.None:
                            base.m_DataType = FieldType.Text;
                            break;
                    ...
                    this.Format = WinHelp.GetFormat(value);
                    //base.m_DataType=NativeMethods.GetBaseFormat  (value);
                    //m_IsSum=NativeMethods.GetBaseFormat  (value)==FieldType.Number;
                    this.Invalidate();
                }
            }
        }
