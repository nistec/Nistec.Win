namespace MControl.GridView
{
    ...
    /// <summary>Provides data for the <see cref="E:MControl.GridView.Grid.RowPrePaint"></see> event. </summary>
    /// <filterpriority>2</filterpriority>
    public class GridRowPrePaintEventArgs : HandledEventArgs
    {
        ...
        internal GridRowPrePaintEventArgs(Grid grid)
        {
            this.grid = grid;
        }

        /// <summary>Initializes a new instance of the <see cref="T:MControl.GridView.GridRowPrePaintEventArgs"></see> class. </summary>
        ...
        public GridRowPrePaintEventArgs(Grid grid, System.Drawing.Graphics graphics, Rectangle clipBounds, Rectangle rowBounds, int rowIndex, GridElementStates rowState, string errorText, GridCellStyle inheritedRowStyle, bool isFirstDisplayedRow, bool isLastVisibleRow)
        {
            if (grid == null)
            {
            ...
            this.paintParts = GridPaintParts.All;
        }
        ...
        /// <exception cref="T:System.InvalidOperationException"><see cref="P:MControl.GridView.GridRowPrePaintEventArgs.RowIndex"></see> is less than zero or greater than the number of rows in the <see cref="T:MControl.GridView.Grid"></see> control minus one.</exception>
        ...
        /// <returns>A <see cref="T:MControl.GridView.GridCellStyle"></see> that contains the cell style currently applied to the row.</returns>
        ...
        /// <summary>Gets a value indicating whether the current row is the first row currently displayed in the <see cref="T:MControl.GridView.Grid"></see>.</summary>
        ...
        /// <summary>Gets a value indicating whether the current row is the last visible row in the <see cref="T:MControl.GridView.Grid"></see>.</summary>
        /// <returns>true if the row being painted is currently the last row in the <see cref="T:MControl.GridView.Grid"></see> that has the <see cref="P:MControl.GridView.GridRow.Visible"></see> property set to true; otherwise, false.</returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// <exception cref="T:System.ArgumentException">The specified value when setting this property is not a valid bitwise combination of <see cref="T:MControl.GridView.GridPaintParts"></see> values.</exception>
        public GridPaintParts PaintParts
        {
            ...
            set
            {
                if ((value & ~GridPaintParts.All) != GridPaintParts.None)
                {
                    throw new ArgumentException(MControl.GridView.RM.GetString("Grid_InvalidGridPaintPartsCombination", new object[] { "value" }));
                }
        ...
        /// <returns>A bitwise combination of the <see cref="T:MControl.GridView.GridElementStates"></see> values that specifies the state of the row.</returns>
        /// <filterpriority>1</filterpriority>
