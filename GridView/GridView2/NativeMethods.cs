namespace MControl.Util
{
    ...
    internal static class NativeMethods
    {
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.CHARFORMAT2A));
            public int dwMask;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.CHARFORMATA));
            public int dwMask;
            public int dwEffects;
            public int yHeight;
            public int yOffset;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.CHARFORMATW));
            public int dwMask;
            public int dwEffects;
            public int yHeight;
            public int yOffset;
        ...
        {
            public int lStructSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.CHOOSECOLOR));
            ...
            public MControl.Util.NativeMethods.WndProc lpfnHook;
        ...
        {
            public int lStructSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.CHOOSEFONT));
            public IntPtr hwndOwner;
            public IntPtr hDC;
        ...
        public class COMRECT
        {
            ...
            public static MControl.Util.NativeMethods.COMRECT FromXYWH(int x, int y, int width, int height)
            {
                return new MControl.Util.NativeMethods.COMRECT(x, y, x + width, y + height);
            }
        ...
        public class DOCHOSTUIINFO
        {
            ...
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.DOCHOSTUIINFO));
        ...
        public class DRAWITEMSTRUCT
        {
            ...
            public MControl.Util.NativeMethods.RECT rcItem;
        ...
        public class EDITSTREAM
        {
            ...
            public int dwError;
            public MControl.Util.NativeMethods.EditStreamCallback pfnCallback;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR nmhdr;
        ...
        public class ENLINK
        {
            ...
            public MControl.Util.NativeMethods.CHARRANGE charrange;
        }
        ...
        public class ENPROTECTED
        {
            ...
            public MControl.Util.NativeMethods.CHARRANGE chrg;
        }
        ...
        {
            public int cbSizeOfStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.FONTDESC));
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.HELPINFO));
            public int iContextType;
            public int iCtrlId;
            public IntPtr hItemHandle = IntPtr.Zero;
            public int dwContextId;
            public MControl.Util.NativeMethods.POINT MousePos;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Auto)]
        public class HH_AKLINK
        {
            internal int cbStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.HH_AKLINK));
        ...
        {
            internal int cbStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.HH_FTS_QUERY));
        ...
        {
            internal int cbStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.HH_POPUP));
            internal IntPtr hinst = IntPtr.Zero;
            internal int idString;
            internal IntPtr pszText;
            internal MControl.Util.NativeMethods.POINT pt;
            internal int clrForeground = -1;
            internal int clrBackground = -1;
            internal MControl.Util.NativeMethods.RECT rcMargins = MControl.Util.NativeMethods.RECT.FromXYWH(-1, -1, -1, -1);
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.IMAGELISTDRAWPARAMS));
        ...
        {
            public int type;
            public MControl.Util.NativeMethods.INPUTUNION inputUnion;
        }
        ...
        {
            [FieldOffset(0)]
            public MControl.Util.NativeMethods.HARDWAREINPUT hi;
            [FieldOffset(0)]
            public MControl.Util.NativeMethods.KEYBDINPUT ki;
            [FieldOffset(0)]
            public MControl.Util.NativeMethods.MOUSEINPUT mi;
        }

        [ComImport, Guid("B722BCCB-4E68-101B-A2BC-00AA00404770"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), CLSCompliant(false), ComVisible(true)]
        public interface IOleCommandTarget
        {
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
            int QueryStatus(ref Guid pguidCmdGroup, int cCmds, [In, Out] MControl.Util.NativeMethods.OLECMD prgCmds, [In, Out] IntPtr pCmdText);
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
        ...
        public interface IPerPropertyBrowsing
        {
            ...
            [PreserveSig]
            int GetPredefinedStrings(int dispID, [Out] MControl.Util.NativeMethods.CA_STRUCT pCaStringsOut, [Out] MControl.Util.NativeMethods.CA_STRUCT pCaCookiesOut);
            [PreserveSig]
            int GetPredefinedValue(int dispID, [In, MarshalAs(UnmanagedType.U4)] int dwCookie, [Out] MControl.Util.NativeMethods.VARIANT pVarOut);
        }
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("33C0C1D8-33CF-11d3-BFF2-00C04F990235")]
        ...
        {
            void GetPages([Out] MControl.Util.NativeMethods.tagCAUUID pPages);
        }
        ...
        public class LOGFONT
        {
            ...
            public LOGFONT(MControl.Util.NativeMethods.LOGFONT lf)
            {
        ...
        {
            public uint cbSize = ((uint) Marshal.SizeOf(typeof(MControl.Util.NativeMethods.LVGROUP)));
            public uint mask;
        ...
        {
            public uint cbSize = ((uint) Marshal.SizeOf(typeof(MControl.Util.NativeMethods.LVINSERTMARK)));
            public int dwFlags;
            public int iItem;
            public int dwReserved;
        }
        ...
        {
            public uint cbSize = ((uint) Marshal.SizeOf(typeof(MControl.Util.NativeMethods.LVTILEVIEWINFO)));
            public int dwMask;
            public int dwFlags;
            public MControl.Util.NativeMethods.SIZE sizeTile;
            public int cLines;
            public MControl.Util.NativeMethods.RECT rcLabelMargin;
        }
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MCHITTESTINFO));
            public int pt_x;
            public int pt_y;
            public int uHit;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MENUITEMINFO_T));
            public int fMask;
            public int fType;
            public int fState;
            public int wID;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MENUITEMINFO_T_RW));
            public int fMask;
            public int fType;
            public int fState;
            public int wID;
        ...
        {
            public MControl.Util.NativeMethods.POINT ptReserved;
            public MControl.Util.NativeMethods.POINT ptMaxSize;
            public MControl.Util.NativeMethods.POINT ptMaxPosition;
            public MControl.Util.NativeMethods.POINT ptMinTrackSize;
            public MControl.Util.NativeMethods.POINT ptMaxTrackSize;
        }
        ...
        {
            internal int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MONITORINFO));
            internal MControl.Util.NativeMethods.RECT rcMonitor = new MControl.Util.NativeMethods.RECT();
            internal MControl.Util.NativeMethods.RECT rcWork = new MControl.Util.NativeMethods.RECT();
        ...
        {
            internal int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MONITORINFOEX));
            internal MControl.Util.NativeMethods.RECT rcMonitor = new MControl.Util.NativeMethods.RECT();
            internal MControl.Util.NativeMethods.RECT rcWork = new MControl.Util.NativeMethods.RECT();
            internal int dwFlags;
            [MarshalAs(UnmanagedType.ByValArray, SizeConst=0x20)]
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.MSOCRINFOSTRUCT));
        ...
        {
            public MControl.Util.NativeMethods.NMHDR nmcd;
            public int dwDrawStage;
            public IntPtr hdc;
            public MControl.Util.NativeMethods.RECT rc;
        ...
        public class NMDATETIMECHANGE
        {
            public MControl.Util.NativeMethods.NMHDR nmhdr;
            public int dwFlags;
            public MControl.Util.NativeMethods.SYSTEMTIME st;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR nmhdr;
            public MControl.Util.NativeMethods.SYSTEMTIME stStart;
        ...
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public int iItem;
            public int iSubItem;
        ...
        {
            public MControl.Util.NativeMethods.NMCUSTOMDRAW nmcd;
            public int clrText;
            ...
            public int iPartId;
            public int iStateId;
            public MControl.Util.NativeMethods.RECT rcText;
            public uint uAlign;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public MControl.Util.NativeMethods.LVITEM item;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public MControl.Util.NativeMethods.LVITEM_NOTEXT item;
        }
        ...
        public struct NMLVFINDITEM
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public int iStart;
            public MControl.Util.NativeMethods.LVFINDINFO lvfi;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR nmhdr;
            public MControl.Util.NativeMethods.SYSTEMTIME stSelStart;
            public MControl.Util.NativeMethods.SYSTEMTIME stSelEnd;
        }
        ...
        public struct NMTOOLBAR
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public int iItem;
            public MControl.Util.NativeMethods.TBBUTTON tbButton;
            public int cchText;
            public IntPtr pszText;
        }
        ...
        public struct NMTREEVIEW
        {
            public MControl.Util.NativeMethods.NMHDR nmhdr;
            public int action;
            public MControl.Util.NativeMethods.TV_ITEM itemOld;
            public MControl.Util.NativeMethods.TV_ITEM itemNew;
            public int ptDrag_X;
            public int ptDrag_Y;
        }
        ...
        {
            public MControl.Util.NativeMethods.NMHDR hdr;
            public MControl.Util.NativeMethods.TV_ITEM item;
        }
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.NONCLIENTMETRICS));
            ...
            public MControl.Util.NativeMethods.LOGFONT lfCaptionFont;
            public int iSmCaptionWidth;
            public int iSmCaptionHeight;
            [MarshalAs(UnmanagedType.Struct)]
            public MControl.Util.NativeMethods.LOGFONT lfSmCaptionFont;
            public int iMenuWidth;
            public int iMenuHeight;
            [MarshalAs(UnmanagedType.Struct)]
            public MControl.Util.NativeMethods.LOGFONT lfMenuFont;
            [MarshalAs(UnmanagedType.Struct)]
            public MControl.Util.NativeMethods.LOGFONT lfStatusFont;
            [MarshalAs(UnmanagedType.Struct)]
            public MControl.Util.NativeMethods.LOGFONT lfMessageFont;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Auto)]
        public class NOTIFYICONDATA
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.NOTIFYICONDATA));
            public IntPtr hWnd;
            public int uID;
            public int uFlags;
        ...
        {
            public int cbSizeOfStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.OCPFIPARAMS));
            public IntPtr hwndOwner;
            public int x;
            public int y;
        ...
        {
            public int lStructSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.OPENFILENAME_I));
            public IntPtr hwndOwner;
            public IntPtr hInstance;
        ...
        public class PAGESETUPDLG
        {
            ...
            public IntPtr lCustData = IntPtr.Zero;
            public MControl.Util.NativeMethods.WndProc lpfnPageSetupHook;
            public MControl.Util.NativeMethods.WndProc lpfnPagePaintHook;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.PARAFORMAT));
            public int dwMask;
        ...
        public class PICTDESC
        {
            ...
            internal int union2;
            internal int union3;
            public static MControl.Util.NativeMethods.PICTDESC CreateBitmapPICTDESC(IntPtr hbitmap, IntPtr hpal)
            {
                MControl.Util.NativeMethods.PICTDESC pictdesc = new MControl.Util.NativeMethods.PICTDESC();
            ...
            public static MControl.Util.NativeMethods.PICTDESC CreateIconPICTDESC(IntPtr hicon)
            {
                MControl.Util.NativeMethods.PICTDESC pictdesc = new MControl.Util.NativeMethods.PICTDESC();
        ...
        {
            internal int cbSizeOfStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.PICTDESCbmp));
        ...
        {
            internal int cbSizeOfStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.PICTDESCemf));
        ...
        {
            internal int cbSizeOfStruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.PICTDESCicon));
        ...
        public class PRINTDLG
        {
            ...
            public MControl.Util.NativeMethods.WndProc lpfnPrintHook;
            public MControl.Util.NativeMethods.WndProc lpfnSetupHook;
        ...
        public class PRINTDLGEX
        {
            ...
            [MarshalAs(UnmanagedType.LPStr)]
            public string lpPrintTemplateName;
            public MControl.Util.NativeMethods.WndProc lpCallback;
        ...
        public class SCROLLINFO
        {
            ...
            public SCROLLINFO()
            {
                this.cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.SCROLLINFO));
            }
        ...
        {
            [MarshalAs(UnmanagedType.U4)]
            public int cb = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.tagCONTROLINFO));
        ...
        {
            public MControl.Util.NativeMethods.tagTYPEDESC tdesc;
            public MControl.Util.NativeMethods.tagPARAMDESC paramdesc;
        }
        ...
        {
            public int cbSizeofstruct = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.tagFONTDESC));
            [MarshalAs(UnmanagedType.LPWStr)]
            public string lpstrName;
        ...
        public sealed class tagFUNCDESC
        {
            ...
            public MControl.Util.NativeMethods.value_tagELEMDESC elemdescFunc;
            [MarshalAs(UnmanagedType.U2)]
        ...
        {
            [MarshalAs(UnmanagedType.U4)]
            public int cbLicInfo = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.tagLICINFO));
        ...
        public sealed class tagTYPEATTR
        {
            ...
            public MControl.Util.NativeMethods.tagTYPEDESC Get_tdescAlias()
            {
                MControl.Util.NativeMethods.tagTYPEDESC gtypedesc = new MControl.Util.NativeMethods.tagTYPEDESC();
                gtypedesc.unionMember = (IntPtr) this.tdescAlias_unionMember;
                gtypedesc.vt = this.tdescAlias_vt;
                return gtypedesc;
            }

            public MControl.Util.NativeMethods.tagIDLDESC Get_idldescType()
            {
                MControl.Util.NativeMethods.tagIDLDESC gidldesc = new MControl.Util.NativeMethods.tagIDLDESC();
        ...
        public sealed class tagVARDESC
        {
            ...
            public MControl.Util.NativeMethods.value_tagELEMDESC elemdescVar;
            [MarshalAs(UnmanagedType.U2)]
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.TOOLINFO_T));
            public int uFlags;
            public IntPtr hwnd;
            public IntPtr uId;
            public MControl.Util.NativeMethods.RECT rect;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.TOOLINFO_TOOLTIP));
            public int uFlags;
            public IntPtr hwnd;
            public IntPtr uId;
            public MControl.Util.NativeMethods.RECT rect;
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.TPMPARAMS));
        ...
        {
            public int cbSize = Marshal.SizeOf(typeof(MControl.Util.NativeMethods.TRACKMOUSEEVENT));
            public int dwFlags;
        ...
        {
            public IntPtr hParent;
            public MControl.Util.NativeMethods.TreeViewCompareCallback lpfnCompare;
            public IntPtr lParam;
        }
        ...
        public sealed class VARIANT
        {
            ...
            public static MControl.Util.NativeMethods.VARIANT FromObject(object var)
            {
                MControl.Util.NativeMethods.VARIANT variant = new MControl.Util.NativeMethods.VARIANT();
                if (var == null)
                {
                    variant.vt = 0;
                    return variant;
                ...
                switch (num2)
                {
                    ...
                    default:
                        ...
                        switch (num2)
                        {
                            ...
                            case 12:
                            {
                                MControl.Util.NativeMethods.VARIANT variant = (MControl.Util.NativeMethods.VARIANT) System.Windows.Forms.UnsafeNativeMethods.PtrToStructure(refInt, typeof(MControl.Util.NativeMethods.VARIANT));
            ...
            Label_03B7:
                num3 = this.vt;
                throw new ArgumentException(System.Windows.Forms.SR.GetString("COM2UnhandledVT", new object[] { num3.ToString(CultureInfo.InvariantCulture) }));
            }
        ...
        {
            public int style;
            public MControl.Util.NativeMethods.WndProc lpfnWndProc;
